 ...
 */
public class RuntimeMaximalGlobalGraphCreator 
{
	...
	private static final Log LOG = LogFactory.getLog(RuntimeMaximalGlobalGraphCreator.class);
	
	
	public RuntimeMaximalGlobalGraphCreator() {
