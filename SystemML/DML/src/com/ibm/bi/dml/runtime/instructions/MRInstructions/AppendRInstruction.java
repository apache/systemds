...
public class AppendRInstruction extends BinaryMRInstructionBase 
{
	...
	public AppendRInstruction(Operator op, byte in1, byte in2, long offset, long offset2, byte out, String istr)
	{
		super(op, in1, in2, out);
		_offset = offset;
		_offset2 = offset2;
		_clen = _offset + _offset2;
		mrtype = MRINSTRUCTION_TYPE.AppendR;
		instString = istr;
	}
	...
	public static Instruction parseInstruction ( String str ) throws DMLRuntimeException {
		...
		return new AppendRInstruction(null, in1, in2, offset, clen, out, str);
	}
		...
		if( blkList2 != null ) 
			for( IndexedMatrixValue in2 : blkList2 )
			{
				...
				{		
					...
					int cols1 = Math.min(bclen, (int)(_clen-(cix1-1)*bclen));
