...
abstract public class Hops {
	...
	static public HashMap<DataOpTypes, dml.lops.Data.OperationTypes> HopsData2Lops;
	static {
		HopsData2Lops = new HashMap<Hops.DataOpTypes, dml.lops.Data.OperationTypes>();
		HopsData2Lops.put(DataOpTypes.PERSISTENTREAD, dml.lops.Data.OperationTypes.READ);
		HopsData2Lops.put(DataOpTypes.PERSISTENTWRITE, dml.lops.Data.OperationTypes.WRITE);
		HopsData2Lops.put(DataOpTypes.TRANSIENTWRITE, dml.lops.Data.OperationTypes.WRITE);
		HopsData2Lops.put(DataOpTypes.TRANSIENTREAD, dml.lops.Data.OperationTypes.READ);
	}

	static public HashMap<Hops.AggOp, dml.lops.Aggregate.OperationTypes> HopsAgg2Lops;
	static {
		HopsAgg2Lops = new HashMap<Hops.AggOp, dml.lops.Aggregate.OperationTypes>();
		HopsAgg2Lops.put(AggOp.SUM, dml.lops.Aggregate.OperationTypes.KahanSum);
	...
	static public HashMap<Hops.ReorgOp, dml.lops.Transform.OperationTypes> HopsTransf2Lops;
	static {
		HopsTransf2Lops = new HashMap<Hops.ReorgOp, dml.lops.Transform.OperationTypes>();
		HopsTransf2Lops.put(ReorgOp.TRANSPOSE, dml.lops.Transform.OperationTypes.Transpose);
		HopsTransf2Lops.put(ReorgOp.DIAG_V2M, dml.lops.Transform.OperationTypes.VectortoDiagMatrix);
		//HopsTransf2Lops.put(ReorgOp.DIAG_M2V, dml.lops.Transform.OperationTypes.MatrixtoDiagVector);

	}

	static public HashMap<Hops.Direction, dml.lops.PartialAggregate.DirectionTypes> HopsDirection2Lops;
	static {
		HopsDirection2Lops = new HashMap<Hops.Direction, dml.lops.PartialAggregate.DirectionTypes>();
		HopsDirection2Lops.put(Direction.RowCol, dml.lops.PartialAggregate.DirectionTypes.RowCol);
		HopsDirection2Lops.put(Direction.Col, dml.lops.PartialAggregate.DirectionTypes.Col);
		HopsDirection2Lops.put(Direction.Row, dml.lops.PartialAggregate.DirectionTypes.Row);

	}

	static public HashMap<Hops.OpOp2, dml.lops.Binary.OperationTypes> HopsOpOp2LopsB;
	static {
		HopsOpOp2LopsB = new HashMap<Hops.OpOp2, dml.lops.Binary.OperationTypes>();
		HopsOpOp2LopsB.put(OpOp2.PLUS, dml.lops.Binary.OperationTypes.ADD);
		HopsOpOp2LopsB.put(OpOp2.MINUS, dml.lops.Binary.OperationTypes.SUBTRACT);
		HopsOpOp2LopsB.put(OpOp2.MULT, dml.lops.Binary.OperationTypes.MULTIPLY);
		HopsOpOp2LopsB.put(OpOp2.DIV, dml.lops.Binary.OperationTypes.DIVIDE);
		HopsOpOp2LopsB.put(OpOp2.LESS, dml.lops.Binary.OperationTypes.LESS_THAN);
		HopsOpOp2LopsB.put(OpOp2.LESSEQUAL, dml.lops.Binary.OperationTypes.LESS_THAN_OR_EQUALS);
		HopsOpOp2LopsB.put(OpOp2.GREATER, dml.lops.Binary.OperationTypes.GREATER_THAN);
		HopsOpOp2LopsB.put(OpOp2.GREATEREQUAL, dml.lops.Binary.OperationTypes.GREATER_THAN_OR_EQUALS);
		HopsOpOp2LopsB.put(OpOp2.EQUAL, dml.lops.Binary.OperationTypes.EQUALS);
		HopsOpOp2LopsB.put(OpOp2.NOTEQUAL, dml.lops.Binary.OperationTypes.NOT_EQUALS);
		HopsOpOp2LopsB.put(OpOp2.MIN, dml.lops.Binary.OperationTypes.MIN);
		HopsOpOp2LopsB.put(OpOp2.MAX, dml.lops.Binary.OperationTypes.MAX);
		HopsOpOp2LopsB.put(OpOp2.AND, dml.lops.Binary.OperationTypes.OR);
		HopsOpOp2LopsB.put(OpOp2.OR, dml.lops.Binary.OperationTypes.AND);
		HopsOpOp2LopsB.put(OpOp2.POW, dml.lops.Binary.OperationTypes.NOTSUPPORTED);
		HopsOpOp2LopsB.put(OpOp2.LOG, dml.lops.Binary.OperationTypes.NOTSUPPORTED);
	}

	static public HashMap<Hops.OpOp2, dml.lops.BinaryCP.OperationTypes> HopsOpOp2LopsBS;
	static {
		HopsOpOp2LopsBS = new HashMap<Hops.OpOp2, dml.lops.BinaryCP.OperationTypes>();
		HopsOpOp2LopsBS.put(OpOp2.PLUS, dml.lops.BinaryCP.OperationTypes.ADD);
		HopsOpOp2LopsBS.put(OpOp2.MINUS, dml.lops.BinaryCP.OperationTypes.SUBTRACT);
		HopsOpOp2LopsBS.put(OpOp2.MULT, dml.lops.BinaryCP.OperationTypes.MULTIPLY);
		HopsOpOp2LopsBS.put(OpOp2.DIV, dml.lops.BinaryCP.OperationTypes.DIVIDE);
		HopsOpOp2LopsBS.put(OpOp2.LESS, dml.lops.BinaryCP.OperationTypes.LESS_THAN);
		HopsOpOp2LopsBS.put(OpOp2.LESSEQUAL, dml.lops.BinaryCP.OperationTypes.LESS_THAN_OR_EQUALS);
		HopsOpOp2LopsBS.put(OpOp2.GREATER, dml.lops.BinaryCP.OperationTypes.GREATER_THAN);
		HopsOpOp2LopsBS.put(OpOp2.GREATEREQUAL, dml.lops.BinaryCP.OperationTypes.GREATER_THAN_OR_EQUALS);
		HopsOpOp2LopsBS.put(OpOp2.EQUAL, dml.lops.BinaryCP.OperationTypes.EQUALS);
		HopsOpOp2LopsBS.put(OpOp2.NOTEQUAL, dml.lops.BinaryCP.OperationTypes.NOT_EQUALS);
		HopsOpOp2LopsBS.put(OpOp2.MIN, dml.lops.BinaryCP.OperationTypes.MIN);
		HopsOpOp2LopsBS.put(OpOp2.MAX, dml.lops.BinaryCP.OperationTypes.MAX);
		HopsOpOp2LopsBS.put(OpOp2.AND, dml.lops.BinaryCP.OperationTypes.AND);
		HopsOpOp2LopsBS.put(OpOp2.OR, dml.lops.BinaryCP.OperationTypes.OR);
		HopsOpOp2LopsBS.put(OpOp2.LOG, dml.lops.BinaryCP.OperationTypes.LOG);
		HopsOpOp2LopsBS.put(OpOp2.POW, dml.lops.BinaryCP.OperationTypes.POW);
		HopsOpOp2LopsBS.put(OpOp2.PRINT, dml.lops.BinaryCP.OperationTypes.PRINT);
	}

	static public HashMap<Hops.OpOp2, dml.lops.Unary.OperationTypes> HopsOpOp2LopsU;
	static {
		HopsOpOp2LopsU = new HashMap<Hops.OpOp2, dml.lops.Unary.OperationTypes>();
		HopsOpOp2LopsU.put(OpOp2.PLUS, dml.lops.Unary.OperationTypes.ADD);
		HopsOpOp2LopsU.put(OpOp2.MINUS, dml.lops.Unary.OperationTypes.SUBTRACT);
		HopsOpOp2LopsU.put(OpOp2.MULT, dml.lops.Unary.OperationTypes.MULTIPLY);
		HopsOpOp2LopsU.put(OpOp2.DIV, dml.lops.Unary.OperationTypes.DIVIDE);
		HopsOpOp2LopsU.put(OpOp2.LESSEQUAL, dml.lops.Unary.OperationTypes.LESS_THAN_OR_EQUALS);
		HopsOpOp2LopsU.put(OpOp2.LESS, dml.lops.Unary.OperationTypes.LESS_THAN);
		HopsOpOp2LopsU.put(OpOp2.GREATEREQUAL, dml.lops.Unary.OperationTypes.GREATER_THAN_OR_EQUALS);
		HopsOpOp2LopsU.put(OpOp2.GREATER, dml.lops.Unary.OperationTypes.GREATER_THAN);
		HopsOpOp2LopsU.put(OpOp2.EQUAL, dml.lops.Unary.OperationTypes.EQUALS);
		HopsOpOp2LopsU.put(OpOp2.NOTEQUAL, dml.lops.Unary.OperationTypes.NOT_EQUALS);
		HopsOpOp2LopsU.put(OpOp2.AND, dml.lops.Unary.OperationTypes.NOTSUPPORTED);
		HopsOpOp2LopsU.put(OpOp2.OR, dml.lops.Unary.OperationTypes.NOTSUPPORTED);
		HopsOpOp2LopsU.put(OpOp2.MAX, dml.lops.Unary.OperationTypes.MAX);
		HopsOpOp2LopsU.put(OpOp2.MIN, dml.lops.Unary.OperationTypes.MIN);
		HopsOpOp2LopsU.put(OpOp2.LOG, dml.lops.Unary.OperationTypes.LOG);
		HopsOpOp2LopsU.put(OpOp2.POW, dml.lops.Unary.OperationTypes.POW);
	}

	static public HashMap<Hops.OpOp1, dml.lops.Unary.OperationTypes> HopsOpOp1LopsU;
	static {
		HopsOpOp1LopsU = new HashMap<Hops.OpOp1, dml.lops.Unary.OperationTypes>();
		HopsOpOp1LopsU.put(OpOp1.MINUS, dml.lops.Unary.OperationTypes.NOTSUPPORTED);
		HopsOpOp1LopsU.put(OpOp1.NOT, dml.lops.Unary.OperationTypes.NOT);
		HopsOpOp1LopsU.put(OpOp1.ABS, dml.lops.Unary.OperationTypes.ABS);
		HopsOpOp1LopsU.put(OpOp1.SIN, dml.lops.Unary.OperationTypes.SIN);
		HopsOpOp1LopsU.put(OpOp1.COS, dml.lops.Unary.OperationTypes.COS);
		HopsOpOp1LopsU.put(OpOp1.TAN, dml.lops.Unary.OperationTypes.TAN);
		HopsOpOp1LopsU.put(OpOp1.SQRT, dml.lops.Unary.OperationTypes.SQRT);
		HopsOpOp1LopsU.put(OpOp1.EXP, dml.lops.Unary.OperationTypes.EXP);
		HopsOpOp1LopsU.put(OpOp1.LOG, dml.lops.Unary.OperationTypes.LOG);
		HopsOpOp1LopsU.put(OpOp1.ROUND, dml.lops.Unary.OperationTypes.ROUND);
		HopsOpOp1LopsU.put(OpOp1.CAST_AS_SCALAR, dml.lops.Unary.OperationTypes.NOTSUPPORTED);
	}

	static public HashMap<Hops.OpOp1, dml.lops.UnaryCP.OperationTypes> HopsOpOp1LopsUS;
	static {
		HopsOpOp1LopsUS = new HashMap<Hops.OpOp1, dml.lops.UnaryCP.OperationTypes>();
		HopsOpOp1LopsUS.put(OpOp1.MINUS, dml.lops.UnaryCP.OperationTypes.NOTSUPPORTED);
		HopsOpOp1LopsUS.put(OpOp1.NOT, dml.lops.UnaryCP.OperationTypes.NOT);
		HopsOpOp1LopsUS.put(OpOp1.ABS, dml.lops.UnaryCP.OperationTypes.ABS);
		HopsOpOp1LopsUS.put(OpOp1.SIN, dml.lops.UnaryCP.OperationTypes.SIN);
		HopsOpOp1LopsUS.put(OpOp1.COS, dml.lops.UnaryCP.OperationTypes.COS);
		HopsOpOp1LopsUS.put(OpOp1.TAN, dml.lops.UnaryCP.OperationTypes.TAN);
		HopsOpOp1LopsUS.put(OpOp1.SQRT, dml.lops.UnaryCP.OperationTypes.SQRT);
		HopsOpOp1LopsUS.put(OpOp1.EXP, dml.lops.UnaryCP.OperationTypes.EXP);
		HopsOpOp1LopsUS.put(OpOp1.LOG, dml.lops.UnaryCP.OperationTypes.LOG);
		HopsOpOp1LopsUS.put(OpOp1.CAST_AS_SCALAR, dml.lops.UnaryCP.OperationTypes.CAST_AS_SCALAR);
		HopsOpOp1LopsUS.put(OpOp1.NROW, dml.lops.UnaryCP.OperationTypes.NROW);
		HopsOpOp1LopsUS.put(OpOp1.NCOL, dml.lops.UnaryCP.OperationTypes.NCOL);
		HopsOpOp1LopsUS.put(OpOp1.LENGTH, dml.lops.UnaryCP.OperationTypes.LENGTH);
		HopsOpOp1LopsUS.put(OpOp1.PRINT, dml.lops.UnaryCP.OperationTypes.PRINT);
		HopsOpOp1LopsUS.put(OpOp1.PRINT2, dml.lops.UnaryCP.OperationTypes.PRINT2);
		HopsOpOp1LopsUS.put(OpOp1.ROUND, dml.lops.UnaryCP.OperationTypes.ROUND);
	}
	...
	static public HashMap<Hops.ParamBuiltinOp, dml.lops.ParameterizedBuiltin.OperationTypes> HopsParameterizedBuiltinLops;
	static {
		HopsParameterizedBuiltinLops = new HashMap<Hops.ParamBuiltinOp, dml.lops.ParameterizedBuiltin.OperationTypes>();
		HopsParameterizedBuiltinLops.put(ParamBuiltinOp.CDF, dml.lops.ParameterizedBuiltin.OperationTypes.CDF);
	}

	static public HashMap<Hops.FileFormatTypes, dml.lops.OutputParameters.Format> HopsFileFormatTypes2Lops;
	static {
		HopsFileFormatTypes2Lops = new HashMap<Hops.FileFormatTypes, dml.lops.OutputParameters.Format>();
		HopsFileFormatTypes2Lops.put(FileFormatTypes.BINARY, dml.lops.OutputParameters.Format.BINARY);
		HopsFileFormatTypes2Lops.put(FileFormatTypes.TEXT, dml.lops.OutputParameters.Format.TEXT);
