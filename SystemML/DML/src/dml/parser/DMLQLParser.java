...
///////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  final public ELStatement ELStatement() throws ParseException {
  Token t = null;
  ...
  ArrayList<String> partitionOutputs = new ArrayList<String>(), trainFunctionParams = new ArrayList<String>(),
    ...
    jj_consume_token(ENSEMBLE);
    t = jj_consume_token(ID);
                                     eNameStr = t.image;
    jj_consume_token(ON);
    dataList = ReadList();
    jj_consume_token(PARTITION);
    partitionParams = ReadGenericParamList();
    jj_consume_token(AS);
    partitionOutputs = ReadList();
    jj_consume_token(TRAIN);
    t = jj_consume_token(ID);
                            trainFunctionName = t.image;
    trainFunctionParams = ReadList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case AS:
      jj_consume_token(AS);
      trainFunctionOutputs = ReadList();
      break;
    default:
      jj_la1[15] = jj_gen;
      ;
    ...
    case TEST:
      ...
      t = jj_consume_token(ID);
                        testFunctionName  = t.image;
      testFunctionParams = ReadList();
      jj_consume_token(AS);
      testFunctionOutputs = ReadList();
      break;
    default:
      jj_la1[16] = jj_gen;
      ;
                ...
                {if (true) return new ELStatement(eNameStr, dataList, partitionParams, params) ;}
    throw new Error("Missing return statement in function");
  }

  final public ELUseStatement ELUseStatement() throws ParseException {
  ...
  ArrayList<String> dataList = new ArrayList<String>(), partitionOutputs = new ArrayList<String>(),
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SUM:
      aggfunc = jj_consume_token(SUM);
      break;
    case AVG:
      aggfunc = jj_consume_token(AVG);
      break;
    default:
      jj_la1[17] = jj_gen;
      jj_consume_token(-1);
    ...
    errorAggFunctionParams = ReadList();
    jj_consume_token(AS);
    errorAggFunctionOutputs = ReadList();
                CVStatement.AGG agg = null ;
          ...
          {if (true) return new ELUseStatement(eNameStr, dataList, partitionParams, params) ;}
    throw new Error("Missing return statement in function");
  }

  final public CVStatement CVStatement() throws ParseException {
  Token t;
  ...
  Token aggfunc = null;
    ...
    errorAggFunctionOutputs = ReadList();
          if("sum".equals(aggfunc.image))
                ...
                {if (true) return new CVStatement(inputs, partitionParams, params) ;}
    throw new Error("Missing return statement in function");
  }
...
// NOTE: DML only supports default values for scalar datatype
  ...
  final public IterablePredicate IterablePredicate() throws ParseException {
    ...
    range = Expression();
    jj_consume_token(RIGHTPAREN);
         {if (true) return new IterablePredicate(iterVar, range);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Identifier IdentifierOrConstant() throws ParseException {
    ...
    case ID:
      id = Identifier();
                        if (((DataIdentifier)id).getName().startsWith("$")){
                                // replace with constant of appropriate type
                                String argVal = commandArgs.get(((DataIdentifier)id).getName());

                                if (argVal == null)
                                        System.out.println("ERROR: value for " + ((DataIdentifier)id).getName() + " is undefined ");
...
//   WHERE vexpr is an expression that refers to the "value" for the parameter "name"
  ...
  final public InputStatement InputStatement() throws ParseException {
    ...
    case READMATRIX:
      ...
      break;
    case READMARKETMATRIX:
      jj_consume_token(READMARKETMATRIX);
      break;
    default:
      jj_la1[85] = jj_gen;
      jj_consume_token(-1);
  ...
  final public InputStatement ReadInputStatementParamList() throws ParseException {
    ...
    case ID:
      t2 = jj_consume_token(ID);
                        if (t2.image.startsWith("$")){

                                String argVal = commandArgs.get(t2.image);
                                if (argVal == null)
                                        System.out.println("ERROR: value for " + t2.image + " is undefined ");
    ...
    while (true) {
      ...
      if (jj_2_41(2)) {
        ...
        case ID:
          t3 = Identifier();
                                                if (t3.getName().startsWith("$")){
                                                        // replace
                                                        String argVal = commandArgs.get(t3.getName());
                                                        if (argVal == null)
                                                                System.out.println("ERROR: value for " + t3.getName() + " is undefined ");
  ...
  final public OutputStatement OutputStatement() throws ParseException {
    ...
    case WRITEMATRIX:
      ...
      break;
    case WRITEMARKETMATRIX:
      jj_consume_token(WRITEMARKETMATRIX);
      break;
    default:
      jj_la1[90] = jj_gen;
      jj_consume_token(-1);
        ...
        case ID:
          t3 = Identifier();
                                                if (t3.getName().startsWith("$")){
                                                        ...
                                                        String argVal = commandArgs.get(t3.getName());
                                                        if (argVal == null)
                                                                System.out.println("ERROR: Variable " + t3.getName() + " is undefined ");
  ...
  final public PrintStatement PrintStatement() throws ParseException {
    ...
    default:
      ...
      ;
                ...
                if (t1 != null) {
                        ps = new PrintStatement(dequoteStr('\u005c"',t1),id);
                } else {
                        ps = new PrintStatement("",id);
                }
    jj_consume_token(RIGHTPAREN);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SEMICOLON:
  ...
  final public Print2Statement Print2Statement() throws ParseException {
         Expression source;
    jj_consume_token(PRINT2);
    jj_consume_token(LEFTPAREN);
    source = Expression();
    jj_consume_token(RIGHTPAREN);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      ;
                        ...
                        {if (true) return new Print2Statement(source);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x44800,0x44800,0x0,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x0,0x44800,0x44800,0x0,0x10000000,0x40000000,0x0,0x0,0xc00000,0x0,0xc00000,0x0,0xc00000,0xc00000,0x0,0x0,0xc00000,0xc00000,0x0,0xc00000,0x0,0xc00000,0xc00000,0xc00000,0x0,0x0,0x0,0x0,0x40800,0x0,0x44800,0x0,0x0,0x40800,0x0,0x44800,0x1000,0x0,0x0,0x40800,0x0,0x44800,0x0,0x40800,0x0,0x44800,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc00000,0xc00000,0x0,0x0,0xc00000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0xa,0xa,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0xa,0xa,0x0,0x0,0x0,0x100000,0x100000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xfffffff0,0x0,0xfffffff0,0xfffffff0,0xfffffff0,0x0,0x0,0x0,0x0,0x0,0xa,0xa,0x0,0x0,0x0,0xa,0xa,0x0,0x0,0x0,0x0,0xa,0xa,0x0,0x0,0xa,0xa,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xfffffff0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc00,0x0,0x0,0xc00,0x0,0xc00,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x30,0x788,0x7b8,0x0,0x0,0x0,0x10000000,0x10000000,0x0,0x0,0x0,0x0,0x788,0x788,0x0,0x0,0x0,0x2000,0x2000,0x8000000,0x0,0x8000000,0x0,0x8000000,0x8000000,0x0,0x0,0x8000000,0x8000000,0x0,0xfff8003,0x0,0xfff8003,0xfff8003,0xfff8003,0x0,0x0,0x0,0x388,0x0,0x400,0x788,0x0,0x388,0x0,0x400,0x788,0x0,0x0,0x388,0x0,0x400,0x788,0x388,0x0,0x400,0x788,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc000000,0xc000000,0x30000000,0x30000000,0x40000000,0xc000000,0xc000000,0x80000000,0x0,0x8000000,0x8000000,0x8000000,0x8000000,0x0,0x0,0x0,0x0,0x3000000,0x0,0xff8003,0x0,0x44,0x0,0x0,0x0,0x8000000,0x88,0x0,0x0,0x8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8000000,0x0,0x0,0x8000000,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x500000,0x2000,0x4000,0x20000,0x400000,0x400000,0x8000,0x0,0x2000,0x0,0x0,0x500000,0x2000,0x0,0x0,0x0,0x0,0x7000000,0x20000,0x7000000,0x100000,0x7000040,0x7000040,0x20000,0x100000,0x7000040,0x7000040,0x20000,0x3c09000,0x20000,0x3c09000,0x3c09000,0x3c09000,0x2000,0x2000,0x100000,0x0,0x0,0x0,0x500000,0x100000,0x0,0x0,0x0,0x500000,0x0,0x100000,0x0,0x0,0x0,0x500000,0x0,0x0,0x0,0x500000,0xc00,0xc00,0x300,0x300,0x1000,0x3f,0x3f,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8000,0x3c00000,0x3000000,0x0,0x0,0x0,0x100000,0x108000,0x20000,0x0,0x20000,0x0,0x20000,0x0,0x2000,0x2400000,0x20000,0x3400000,0x0,0x2400000,0x20000,0x3400000,0x2000,0x2000000,0x20000,0x400000,0x2000,0x2000,0x3f,0x400000,0x3400000,0x20000,0x400000,0x3400000,0x400000,0x2000,};
   }
