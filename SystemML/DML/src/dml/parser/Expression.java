...
public abstract class Expression {
	...
	public enum BuiltinFunctionOp {
		ABS, SIN, COS, TAN, SQRT, EXP, LOG, DIAG, MIN, MAX, PMIN, PMAX, PPRED, LENGTH, NCOL, NROW, 
		SUM, MEAN, TRANS, RANGE, PROD, ROWSUM, COLSUM, ROWMAX, ROWMIN, ROWMEAN, COLMAX, COLMIN, COLMEAN, 
		TRACE, CAST_AS_SCALAR, CTABLE, QUANTILE, INTERQUANTILE, ROUND, IQM, SPEARMAN, CENTRALMOMENT, COVARIANCE
	};
