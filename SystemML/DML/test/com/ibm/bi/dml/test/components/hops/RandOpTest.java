	...
	public void testConstructLops() throws HopsException, LopsException {
		...
		try {
			assertEquals("CP" + Lop.OPERAND_DELIMITOR + "Rand" + Lop.OPERAND_DELIMITOR + "0"
					...
					+ Lop.OPERAND_DELIMITOR + NUM_ROWS + Lop.DATATYPE_PREFIX + DataType.SCALAR + Lop.VALUETYPE_PREFIX + ValueType.INT + Lop.LITERAL_PREFIX + true
					+ Lop.OPERAND_DELIMITOR + NUM_COLS + Lop.DATATYPE_PREFIX + DataType.SCALAR + Lop.VALUETYPE_PREFIX + ValueType.INT + Lop.LITERAL_PREFIX + true
