...
public class AppendChainTest extends AutomatedTestBase
{
	...
	@Test
	public void testAppendChainVectorCP() {
		commonAppendTest(RUNTIME_PLATFORM.HYBRID, rows, cols1, cols2a, cols3a);
	}
	
	@Test
	public void testAppendChainMatrixCP() {
		commonAppendTest(RUNTIME_PLATFORM.HYBRID, rows, cols1, cols2b, cols3b);
	}
	
	@Test
	public void testAppendChainVectorMR() {
		commonAppendTest(RUNTIME_PLATFORM.HADOOP, rows, cols1, cols2a, cols3a);
	}
	
	@Test
	public void testAppendChainMatrixMR() {
		commonAppendTest(RUNTIME_PLATFORM.HADOOP, rows, cols1, cols2b, cols3b);
	}
	 ...
	 * @param cols3
	 */
	public void commonAppendTest(RUNTIME_PLATFORM platform, int rows, int cols1, int cols2, int cols3)
	{
        ...
        double[][] B1= getRandomMatrix(rows, cols2, min, max, sparsity, System.currentTimeMillis());
        writeInputMatrix("B1", B1, true);
        sparsity=rand.nextDouble();
        double[][] B2= getRandomMatrix(rows, cols2, min, max, sparsity, System.currentTimeMillis());
