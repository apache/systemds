...
public class BinaryUAggChain extends Lop 
{
	 ...
	 */	
	public BinaryUAggChain(Lop input1, Binary.OperationTypes bop, Aggregate.OperationTypes uaop, PartialAggregate.DirectionTypes uadir, DataType dt, ValueType vt) 
		throws LopsException 
	{
