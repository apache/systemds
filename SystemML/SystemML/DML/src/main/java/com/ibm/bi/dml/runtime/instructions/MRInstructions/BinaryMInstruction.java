...
public class BinaryMInstruction extends BinaryMRInstructionBase 
{
	...
	public BinaryMInstruction(Operator op, byte in1, byte in2, CacheType type, byte out, String istr)
	{
	...
	public static Instruction parseInstruction ( String str ) throws DMLRuntimeException {
		...
		if ( opcode.equalsIgnoreCase("map+") ) {
			return new BinaryMInstruction(new BinaryOperator(Plus.getPlusFnObject()), in1, in2, type, out, str);
		} 
		else if ( opcode.equalsIgnoreCase("map-") ) {
			return new BinaryMInstruction(new BinaryOperator(Minus.getMinusFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map*") ) {
			return new BinaryMInstruction(new BinaryOperator(Multiply.getMultiplyFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map/") ) {
			return new BinaryMInstruction(new BinaryOperator(Divide.getDivideFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map^") ) {
			return new BinaryMInstruction(new BinaryOperator(Power.getPowerFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map%%") ) {
			return new BinaryMInstruction(new BinaryOperator(Modulus.getModulusFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map%/%") ) {
			return new BinaryMInstruction(new BinaryOperator(IntegerDivide.getIntegerDivideFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("mapmin") ) {
			return new BinaryMInstruction(new BinaryOperator(Builtin.getBuiltinFnObject("min")), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("mapmax") ) {
			return new BinaryMInstruction(new BinaryOperator(Builtin.getBuiltinFnObject("max")), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map>") ) {
			return new BinaryMInstruction(new BinaryOperator(GreaterThan.getGreaterThanFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map>=") ) {
			return new BinaryMInstruction(new BinaryOperator(GreaterThanEquals.getGreaterThanEqualsFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map<") ) {
			return new BinaryMInstruction(new BinaryOperator(LessThan.getLessThanFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map<=") ) {
			return new BinaryMInstruction(new BinaryOperator(LessThanEquals.getLessThanEqualsFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map==") ) {
			return new BinaryMInstruction(new BinaryOperator(Equals.getEqualsFnObject()), in1, in2, type, out, str);
		}
		else if ( opcode.equalsIgnoreCase("map!=") ) {
			return new BinaryMInstruction(new BinaryOperator(NotEquals.getNotEqualsFnObject()), in1, in2, type, out, str);
		}
		return null;
	}
	...
	public void processInstruction(Class<? extends MatrixValue> valueClass,
		...
		IndexedMatrixValue in2 = dcInput.getDataBlock((int)in1.getIndexes().getRowIndex(), 1);
