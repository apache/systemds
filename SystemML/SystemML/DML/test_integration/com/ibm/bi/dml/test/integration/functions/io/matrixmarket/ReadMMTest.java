...
public class ReadMMTest extends AutomatedTestBase 
{
	...
	@Test
	public void testMatrixMarket1_CP() {
		runMMTest(1, RUNTIME_PLATFORM.SINGLE_NODE);
	}
	
	@Test
	public void testMatrixMarket1_MR() {
		runMMTest(1, RUNTIME_PLATFORM.HADOOP);
	}
	
	@Test
	public void testMatrixMarket2_CP() {
		runMMTest(2, RUNTIME_PLATFORM.SINGLE_NODE);
	}
	
	@Test
	public void testMatrixMarket2_MR() {
		runMMTest(2, RUNTIME_PLATFORM.HADOOP);
	}
	
	@Test
	public void testMatrixMarket3_CP() {
		runMMTest(3, RUNTIME_PLATFORM.SINGLE_NODE);
	}
	
	@Test
	public void testMatrixMarket3_MR() {
		runMMTest(3, RUNTIME_PLATFORM.HADOOP);
	}
