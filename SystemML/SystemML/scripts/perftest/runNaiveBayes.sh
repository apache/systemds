...
#training
tstart=$SECONDS
${CMD} -f ../algorithms/naive-bayes.dml $DSAH-explain $DASH-stats $DASH-nvargs X=$1 Y=$2 classes=$3 prior=${BASE}/prior conditionals=${BASE}conditionals accuracy=${BASE}/debug_output fmt="csv"
