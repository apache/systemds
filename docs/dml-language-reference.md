...
| lstm                                        | X,  W, bias, out0, c0                               | [N X T*D]                                                 | [D+M X 4M]                                                | [N X T*M] if given_sequences is true else [ N X M ]                                         | return_sequences                                                                                                                                                                              | Perform computation for single-layer unidirectional LSTM (outputs: out, carryOut, cache), where N=batch_size, T=seq_length, D=number of features, M=number of neurons.            |
| lstm_backward                               | X, W, b, out0, c0, given_sequences, dout, dc, cache | [N X T*M] if given_sequences is true else [ N X M]        | [N X M]                                                   | [N X T*D]                                                                                   | return_sequences                                                                                                                                                                              | Perform backward computation for single-layer unidirectional LSTM (outputs: dX, dW, db, dout0, dc0), where N=batch_size, T=seq_length, D=number of features, M=number of neurons. |
