...
**Ubuntu 24.04** Installing R via older CRAN repositories can lead to dependency conflicts. In this case, installing R from the Ubuntu default repositories could be the solution.
