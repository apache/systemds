...
${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=10000 nf=1000 sparse=$DENSE_SP numcat=5 icpt=0 X=$BASE/X10k_1k_dense_k5 Y=$BASE/y10k_1k_dense_k5 fmt=$FORMAT
${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=10000 nf=1000 sparse=$SPARSE_SP numcat=5 icpt=0 X=$BASE/X10k_1k_sparse_k5 Y=$BASE/y10k_1k_sparse_k5 fmt=$FORMAT
...
#${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=100000 nf=1000 sparse=$DENSE_SP numcat=5 icpt=0 X=$BASE/X100k_1k_dense_k5 Y=$BASE/y100k_1k_dense_k5 fmt=$FORMAT
#${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=100000 nf=1000 sparse=$SPARSE_SP numcat=5 icpt=0 X=$BASE/X100k_1k_sparse_k5 Y=$BASE/y100k_1k_sparse_k5 fmt=$FORMAT
...
#${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=1000000 nf=1000 sparse=$DENSE_SP numcat=5 icpt=0 X=$BASE/X1M_1k_dense_k5 Y=$BASE/y1M_1k_dense_k5 fmt=$FORMAT
#${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=1000000 nf=1000 sparse=$SPARSE_SP numcat=5 icpt=0 X=$BASE/X1M_1k_sparse_k5 Y=$BASE/y1M_1k_sparse_k5 fmt=$FORMAT
...
#${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=10000000 nf=1000 sparse=$DENSE_SP numcat=5 icpt=0 X=$BASE/X10M_1k_dense_k5 Y=$BASE/y10M_1k_dense_k5 fmt=$FORMAT
#${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=10000000 nf=1000 sparse=$SPARSE_SP numcat=5 icpt=0 X=$BASE/X10M_1k_sparse_k5 Y=$BASE/y10M_1k_sparse_k5 fmt=$FORMAT
...
#${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=100000000 nf=1000 sparse=$DENSE_SP numcat=5 icpt=0 X=$BASE/X100M_1k_dense_k5 Y=$BASE/y100M_1k_dense_k5 fmt=$FORMAT
#${CMD} -f ../datagen/genRandData4Multinomial.dml $DASH-nvargs nr=100000000 nf=1000 sparse=$SPARSE_SP numcat=5 icpt=0 X=$BASE/X100M_1k_sparse_k5 Y=$BASE/y100M_1k_sparse_k5 fmt=$FORMAT
