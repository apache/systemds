...
def kmeans_predict(file_name, datagen_dir, predict_dir):
...
def config_packets_predict(algos, datagen_dir, predict_dir):
    ...
    for current_algo in algos:
        if current_algo in has_predict:
            ...
            for folder in datagen_folders:
                ...
                conf_path = globals()[algo_func](file_name, datagen_dir, predict_dir)
