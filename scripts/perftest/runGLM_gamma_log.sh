...
for i in 0 1 2; do
   ...
   echo "GLM_gamma_log train ict="$i" on "$1": "$ttrain >> ${PERFTESTPATH}/results/times.txt
   ...
   echo "GLM_gamma_log predict ict="$i" on "$1": "$tpredict >> ${PERFTESTPATH}/results/times.txt
done
