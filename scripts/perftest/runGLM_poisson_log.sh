...
for i in 0 1 2; do
   ...
   echo "GLM_poisson_log train ict="$i" on "$1": "$ttrain >> ${PERFTESTPATH}/results/times.txt
   ...
   echo "GLM_poisson_log predict ict="$i" on "$1": "$tpredict >> ${PERFTESTPATH}/results/times.txt
done
