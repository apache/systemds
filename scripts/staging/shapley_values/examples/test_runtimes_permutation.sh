...
data_file="../data/runtimes_permutation_3000_3perm.csv"
permutations=3
samples=100

echo "Outputfile systemds: $data_file"

echo "instances,runtime_python,runtime_row,runtime_permutation,runtime_legacy" | tee "$data_file"
for instances in $(seq 3000 500 10000); do
