...
conda env create --prefix ./lib/python-venv --file tools/python/python.yaml
conda env create --prefix ./lib/python-venv-ks --file tools/python/python-ks.yaml

# TODO: Determine and set the correct filename for the systemds distribution
# The filename should match the appropriate version and build of systemds for your environment.
lib/python-venv/bin/pip install systemds-3.3.0.dev0-py3-none-any.whl
lib/python-venv-ks/bin/pip install systemds-3.3.0.dev0-py3-none-any.whl
...
#conda activate lib/python-venv
