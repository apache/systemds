...
template <typename T>
void conv2dSparse(int apos, int alen, int* aix, double* avals, T* filter, T* ret, int N, int C, int H, int W, 
			int K, int R, int S, int stride_h, int stride_w, int pad_h, int pad_w, int P, int Q, int numThreads);

template <typename T>
void conv2dBackwardFilterSparseDense(int apos, int alen, int* aix, double* avals, T* rotatedDoutPtr, T* ret, int N, int C, int H, int W, 
			int K, int R, int S, int stride_h, int stride_w, int pad_h, int pad_w, int P, int Q, int numThreads);
