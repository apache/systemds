...
public class Types
{
	...
	public enum AggOp {
		...
		COUNT_DISTINCT(11),
		COUNT_DISTINCT_ROW(12), UNIQUE_ROW(13),
		COUNT_DISTINCT_COL(14), UNIQUE_COL(15),
		COUNT_DISTINCT_APPROX(16),
		COUNT_DISTINCT_APPROX_ROW(17), COUNT_DISTINCT_APPROX_COL(18);
