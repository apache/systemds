...
public class CNodeBinary extends CNode {
	...
	public String toString() {
		switch(_type) {
			...
			case MULT:                     return "b(" + Opcodes.MULT.getName() + ")";
			case DIV:                      return "b(" + Opcodes.DIV.getName() + ")";
			case PLUS:                     return "b(" + Opcodes.PLUS.getName() + ")";
			case MINUS:                    return "b(" + Opcodes.MINUS.getName() + ")";
			case POW:                      return "b(" + Opcodes.POW.getName() + ")";
			case MODULUS:                  return "b(" + Opcodes.MODULUS.getName() + ")";
			case INTDIV:                   return "b(" + Opcodes.INTDIV.getName() + ")";
			case LESS:                     return "b(" + Opcodes.LESS.getName() + ")";
			case LESSEQUAL:                return "b(" + Opcodes.LESSEQUAL.getName() + ")";
			case GREATER:                  return "b(" + Opcodes.GREATER.getName() + ")";
			case GREATEREQUAL:             return "b(" + Opcodes.GREATEREQUAL.getName() + ")";
			case EQUAL:                    return "b(" + Opcodes.EQUAL.getName() + ")";
			case NOTEQUAL:                 return "b(" + Opcodes.NOTEQUAL.getName() + ")";
			case OR:                       return "b(|)";
			case AND:                      return "b(&)";
			case XOR:                      return "b(" + Opcodes.XOR.getName() + ")";
			case BITWAND:                  return "b(" + Opcodes.BITWAND.getName() + ")";
			case SEQ_RIX:                  return "b(seqr)";
			case MINUS1_MULT:              return "b(" + Opcodes.MINUS1_MULT.getName() + ")";
			case MINUS_NZ:                 return "b(" + Opcodes.MINUS_NZ.getName() + ")";
