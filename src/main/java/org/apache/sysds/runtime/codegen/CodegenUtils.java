...
public class CodegenUtils 
{
	...
	private static ConcurrentHashMap<String, SpoofNativeCUDA> _native_op_data = new ConcurrentHashMap<>();
	...
	public static SpoofNativeCUDA getNativeOpData(String name) {
		return _native_op_data.get(name);
	}

	public static void putNativeOpData(SpoofNativeCUDA op) {
