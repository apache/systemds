...
public class CompressionSettingsBuilder {
	...
	private List<CompressionType> validCompressions = new ArrayList<CompressionType>();

	public CompressionSettingsBuilder() {
		this.validCompressions.add(CompressionType.DDC);
		this.validCompressions.add(CompressionType.OLE);
		this.validCompressions.add(CompressionType.RLE);
		this.validCompressions.add(CompressionType.UNCOMPRESSED);
	}
