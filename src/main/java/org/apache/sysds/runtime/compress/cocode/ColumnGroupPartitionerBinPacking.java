 ...
 * 
 * TODO add this back with the new API!
 */
public class ColumnGroupPartitionerBinPacking extends AColumnGroupPartitioner {
	...
	protected ColumnGroupPartitionerBinPacking(CompressedSizeEstimator sizeEstimator, CompressionSettings cs,
		int numRows) {
