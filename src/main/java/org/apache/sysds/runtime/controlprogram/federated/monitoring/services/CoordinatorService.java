...
public class CoordinatorService {
	...
	public void create(CoordinatorModel model) {
		_entityRepository.createEntity(model);
	}
	...
	public void remove(Long id) {
		_entityRepository.removeEntity(id, CoordinatorModel.class);
	}

	public CoordinatorModel get(Long id) {
		return _entityRepository.getEntity(id, CoordinatorModel.class);
	}

	public List<CoordinatorModel> getAll() {
		return  _entityRepository.getAllEntities(CoordinatorModel.class);
	}
}
