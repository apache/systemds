...
public class BinaryFrameScalarCPInstruction extends BinaryCPInstruction
{
	...
	public void processInstruction(ExecutionContext ec)  {
		...
		String stringExpression = ec.getScalarInput(input2.getName(), Types.ValueType.STRING, input2.isLiteral()).getStringValue();
		//compute results
		FrameBlock outBlock = inBlock.dmlMap(stringExpression);
