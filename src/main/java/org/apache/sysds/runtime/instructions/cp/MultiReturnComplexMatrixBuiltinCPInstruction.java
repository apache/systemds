...
public class MultiReturnComplexMatrixBuiltinCPInstruction extends ComputationCPInstruction {
    ...
    private MultiReturnComplexMatrixBuiltinCPInstruction(Operator op, CPOperand input1, CPOperand input2, ArrayList<CPOperand> outputs,
                                                         String opcode,
                                                         String istr, CPOperand windowSize, CPOperand overlap) {
        super(CPType.MultiReturnBuiltin, op, input1, input2, outputs.get(0), opcode, istr, windowSize, overlap);
        _outputs = outputs;
    }
    ...
    public static MultiReturnComplexMatrixBuiltinCPInstruction parseInstruction(String str) {
        ...
        if (parts.length == 5 && opcode.equalsIgnoreCase("ifft")) {
            ...
            return new MultiReturnComplexMatrixBuiltinCPInstruction(null, in1, null, outputs, opcode, str, windowSize, overlap);
            ...
            return new MultiReturnComplexMatrixBuiltinCPInstruction(null, in1, in2, outputs, opcode, str, windowSize, overlap);
        }
        else {
