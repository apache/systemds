...
public class UnaryScalarCPInstruction extends UnaryCPInstruction {
	...
	public void processInstruction(ExecutionContext ec) {
		...
		//core execution
		if ( opcode.equalsIgnoreCase(Opcodes.PRINT.getName()) ) {
		...
		else if ( opcode.equalsIgnoreCase(Opcodes.STOP.getName()) ) {
		...
		else if ( opcode.equalsIgnoreCase(Opcodes.ASSERT.getName()) ) {
