...
public abstract class IndexingFEDInstruction extends UnaryFEDInstruction {
    ...
    protected IndexingFEDInstruction(CPOperand lhsInput, CPOperand rhsInput, CPOperand rl, CPOperand ru,
...
//                    return new ListIndexingCPInstruction(in, rl, ru, cl, cu, out, opcode, str);
                    ...
                    throw new DMLRuntimeException("Can index federated only on matrices.");
            }
            else {
