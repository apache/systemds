...
public class QuaternaryWSigmoidFEDInstruction extends QuaternaryFEDInstruction
{
	...
	// input2 ... U
	// input3 ... V
	protected QuaternaryWSigmoidFEDInstruction(Operator operator,
	...
	public void processInstruction(ExecutionContext ec)
	{
		...
		FederatedRequest frCompute1 = FederationUtils.callInstruction(instString, output,
		...
		Future<FederatedResponse>[] response = fedMap.execute(getTID(), true,
			frInit1, frInit2,
			frCompute1, frGet1,
