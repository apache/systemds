...
public class FileFormatPropertiesHDF5 extends FileFormatProperties implements Serializable {
	...
	private static final long serialVersionUID = -4100839647257309664L;
	...
	public FileFormatPropertiesHDF5(String delim, String indexDelim) {
		this();
		this.delim = delim;
	...
	public FileFormatPropertiesHDF5(String delim, String indexDelim, boolean sparse) {
		this();
		this.delim = delim;
		this.indexDelim = indexDelim;
		this.sparse = sparse;
