...
{
	@Override
	public void writeFrameToHDFS(FrameBlock src, String fname, long rlen, long clen) throws IOException, DMLRuntimeException {
		//prepare file access
	...
	protected void writeProtoFrameToHDFS(Path path, JobConf jobConf, FrameBlock src,
