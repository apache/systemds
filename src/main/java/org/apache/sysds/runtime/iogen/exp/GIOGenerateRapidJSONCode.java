...
public class GIOGenerateRapidJSONCode {
...
//		String sourceFileName = baseSrc + "/source/FrameReaderGIO_" +p + ".cpp";
//		String headerFileName = baseSrc + "/header/FrameReaderGIO_" + p + ".h";
//
//		gr.getReader("FrameReaderGIO_" + p, sourceFileName, headerFileName);
