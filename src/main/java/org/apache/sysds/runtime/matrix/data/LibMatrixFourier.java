...
public class LibMatrixFourier {
	 ...
	 * The first one represents the real values and the second one the imaginary
	 * values.
	 * The output also contains one matrix for the real and one for the imaginary
	 * values.
	 *
	...
	public static MatrixBlock[] fft(MatrixBlock re, MatrixBlock im) {
		...
		System.out.println("fft result in java function:");
		System.out.println((new MatrixBlock[] { re, im })[0].toString());
		System.out.println("\n\n");
	...
	public static MatrixBlock[] ifft(MatrixBlock re, MatrixBlock im) {
		...
		System.out.println("IFFT result in function");
		System.out.println((new MatrixBlock[] { re, im })[0].toString());
		System.out.println("\n\n");
	...
	private static void ifft_one_dim(double[] re, double[] im, double[] re_inter, double[] im_inter, int start,
		...
		// apply fft
		// fft_one_dim_recursive(re, im, re_inter, im_inter, start, step, num,
		// subArraySize);
