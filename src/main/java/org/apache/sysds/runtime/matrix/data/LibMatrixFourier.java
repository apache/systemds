...
public class LibMatrixFourier {
	...
	/**
	 * Function to perform FFT on two given matrices. The first one represents the real values and the second one the
	...
	/**
	 * Function to perform IFFT on two given matrices. The first one represents the real values and the second one the
	 * imaginary values. The output also contains one matrix for the real and one for the imaginary values.
	 *
	 * @param re matrix object representing the real values
	 * @param im matrix object representing the imaginary values
	...
	/**
	 * Function to perform FFT on two given double arrays. The first one represents the real values and the second one
	...
	/**
	 * Function to perform IFFT on two given double arrays. The first one represents the real values and the second one
	 * the imaginary values. Both arrays get updated and contain the result.
	 *
	 * @param re   array representing the real values
	 * @param im   array representing the imaginary values
	...
	/**
	 * Function to perform FFT on a given matrices. The given matrix only represents real values. The output contains
	...
	/**
	 * Function to perform IFFT on a given matrices. The given matrix only represents real values. The output contains
	 * one matrix for the real and one for the imaginary values.
	 *
	 * @param re matrix object representing the real values
	 * @return array of two matrix blocks
