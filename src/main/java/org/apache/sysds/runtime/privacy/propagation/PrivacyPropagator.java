...
public class PrivacyPropagator {
	...
	/**
	 * Returns the output privacy level based on the given input privacy levels and
	 * operator type.
	 ...
	 * @param operatorType type of the operator which is either an aggregation
	 *                     (Aggregate) or not an aggregation (NonAggregate)
	...
	/**
	 * Merges the given privacy constraints with the core propagation using the
	 * given operator type.
	 * 
	 * @param privacyConstraints array of privacy constraints to merge
	 * @param operatorType       type of operation to use when merging with the core
	 *                           propagation
	 ...
	 * @param ec   execution context
	 * @return instruction with propagated privacy constraints (usually the same
	 *         instance as the input inst)
	 */
	 ...
	 * @param ec   execution context
	 * @return instruction with merged privacy constraints propagated to it and
	 *         output CPOperand
	 */
	...
	/**
	 * Propagates privacy constraints from input to instruction and output CPOperand
	 * based on given operator type.
	 ...
	 * @return instruction with the merged privacy constraint propagated to it and
	 *         output CPOperand
	 */
	...
	/**
	 * Throw exception if privacy constraint activated for instruction or for input
	 * to instruction.
	 * 
	 ...
	 * @return privacy constraint of variable or null if privacy constraint is not
	 *         set
	 */
	...
	/**
	 * Returns input privacy constraints as array or returns null if no privacy
	 * constraints are found in the inputs.
	 * 
	 * @param ec     execution context
	 ...
	 * 
	 * @param ec                execution context from which the data variable is
	 *                          retrieved
	 * @param privacyConstraint privacy constraint which the variable should have
	 * @param outputName        name of variable that is retrieved from the
	 *                          execution context
	 */
	...
	/**
	 * Returns input CPOperands of instruction or returns null if instruction type
	...
	/**
	 * Returns a list of output CPOperands of instruction or an empty list if the
	 * instruction has no outputs.
	 * Note that this method needs to be extended as new instruction types are
