...
public interface DoubleParser {
	...
	static double tryDecFloatToDoubleTruncated(long significand, int exponent, boolean isSignificandTruncated,
	...
	static double shortcut(long significand, int power) {
	...
	static double tryDecToDoubleWithFastAlgorithm(long significand, int power) {
