...
//	}
	 ...
	 */
	public void write(String filePath, String format) throws IOException, DMLException, DMLParseException {
		ml.reset();
		ml.registerInput("left", this);
		ml.executeScript("left = read(\"\"); output=left; write(output, \"" + filePath + "\", format=\"" + format + "\");");
	}
	
	private double getScalarBuiltinFunctionResult(String fn) throws IOException, DMLException, DMLParseException {
	 ...
	 * @throws IOException 
	 */
	public long numRows() throws IOException, DMLException, DMLParseException {
		if(mc.rowsKnown()) {
			return mc.getRows();
		}
		else {
	 ...
	 * @throws IOException 
	 */
	public long numCols() throws IOException, DMLException, DMLParseException {
		if(mc.colsKnown()) {
			return mc.getCols();
		}
		else {
	...
	private MLMatrix matrixBinaryOp(MLMatrix that, String op) throws IOException, DMLException, DMLParseException {
	...
	private MLMatrix scalarBinaryOp(Double scalar, String op, boolean isScalarLeft) throws IOException, DMLException, DMLParseException {
		ml.reset();
		ml.registerInput("left", this);
		ml.registerOutput("output");
	...
	public MLMatrix $greater(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, ">");
	}
	
	public MLMatrix $less(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "<");
	}
	
	public MLMatrix $greater$eq(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, ">=");
	}
	
	public MLMatrix $less$eq(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "<=");
	}
	
	public MLMatrix $eq$eq(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "==");
	}
	
	public MLMatrix $bang$eq(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "!=");
	}
	
	public MLMatrix $up(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "^");
	}
	
	public MLMatrix exp(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "^");
	}
	
	public MLMatrix $plus(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "+");
	}
	
	public MLMatrix add(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "+");
	}
	
	public MLMatrix $minus(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "-");
	}
	...
	public MLMatrix $times(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "*");
	}
	
	public MLMatrix elementWiseMultiply(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "*");
	}
	
	public MLMatrix $div(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "/");
	}
	
	public MLMatrix divide(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "/");
	}
	
	public MLMatrix $percent$div$percent(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "%/%");
	}
	
	public MLMatrix integerDivision(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "%/%");
	}
	
	public MLMatrix $percent$percent(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "%%");
	}
	
	public MLMatrix modulus(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "%%");
	}
	
	public MLMatrix $percent$times$percent(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "%*%");
	}
	
	public MLMatrix multiply(MLMatrix that) throws IOException, DMLException, DMLParseException {
		return matrixBinaryOp(that, "%*%");
	}
	
	public MLMatrix transpose() throws IOException, DMLException, DMLParseException {
		ml.reset();
		ml.registerInput("left", this);
		ml.registerOutput("output");
		String script = "left = read(\"\");"
	...
	public MLMatrix $plus(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "+", false);
	}
	
	public MLMatrix add(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "+", false);
	}
	
	public MLMatrix $minus(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "-", false);
	}
	...
	public MLMatrix $times(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "*", false);
	}
	
	public MLMatrix elementWiseMultiply(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "*", false);
	}
	
	public MLMatrix $div(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "/", false);
	}
	
	public MLMatrix divide(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "/", false);
	}
	
	public MLMatrix $greater(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, ">", false);
	}
	
	public MLMatrix $less(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "<", false);
	}
	
	public MLMatrix $greater$eq(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, ">=", false);
	}
	
	public MLMatrix $less$eq(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "<=", false);
	}
	
	public MLMatrix $eq$eq(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "==", false);
	}
	
	public MLMatrix $bang$eq(Double scalar) throws IOException, DMLException, DMLParseException {
		return scalarBinaryOp(scalar, "!=", false);
	}
