...
/**
 * Basic average case estimator for matrix sparsity: sp = 1 -
 * Math.pow(1-sp1*sp2, k)
 */
public class EstimatorBasicAvg extends SparsityEstimator {
	...
	public double estim(MatrixBlock m1, MatrixBlock m2) {
		return estimInternMM(m1.getSparsity(), m2.getSparsity(), m1.getNumRows(), m1.getNumColumns(),
				m2.getNumColumns());
	}
	...
	private double estimIntern(MatrixBlock m1, MatrixBlock m2, OpCode op) {
		double msize = (double) m1.getNumColumns() * m1.getNumRows();
		...
		case CBIND:
			return OptimizerUtils.getSparsity(m1.getNumRows(), m1.getNumColumns() + m1.getNumColumns(),
					m1.getNonZeros() + m2.getNonZeros());
		case RBIND:
			return OptimizerUtils.getSparsity(m1.getNumRows() + m2.getNumRows(), m1.getNumColumns(),
					m1.getNonZeros() + m2.getNonZeros());
