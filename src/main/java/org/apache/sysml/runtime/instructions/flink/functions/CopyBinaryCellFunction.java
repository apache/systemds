...
public class CopyBinaryCellFunction
		implements MapFunction<Tuple2<MatrixIndexes, MatrixCell>, Tuple2<MatrixIndexes, MatrixCell>> {

	public CopyBinaryCellFunction() {
	}

	@Override
	public Tuple2<MatrixIndexes, MatrixCell> map(Tuple2<MatrixIndexes, MatrixCell> arg0) throws Exception {
