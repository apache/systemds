...
public class MatrixIndexingGPUInstruction extends GPUInstruction {
	...
	public void processInstruction(ExecutionContext ec)
		...
		if ( opcode.equalsIgnoreCase("rangeReIndex") ) {
			...
			long outRLen = mat1.getNumRows();
			long outCLen = mat1.getNumColumns();
			UpdateType updateType = mat1.getUpdateType();
			...
			out = updateType.isInPlace() ? GPUUtils.shallowCopy(gCtx, mat1, out) : GPUUtils.deepCopy(gCtx, mat1, out);
			
			// TODO: Handle sparse cases
			out = LibMatrixCUDA.getDenseMatrixOutputForGPUInstruction(ec, getExtendedOpcode(),  output.getName(), outRLen, outCLen);
			LibMatrixCUDA.denseLeftIndexingOperations(ec, gCtx, instName, out, mat2, ixrange);
