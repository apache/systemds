 ...
 */
public class CustomSystemMLKernels {
...
//	private final int deviceNum;
	 ...
	 */
	CustomSystemMLKernels(int deviceNum) throws DMLRuntimeException {
//		this.deviceNum = deviceNum;
	...
	private Pointer initKernels(String ptxFileName) throws DMLRuntimeException {
        ...
        try {
            in = CustomSystemMLKernels.class.getResourceAsStream(ptxFileName);
            if (in != null) {
