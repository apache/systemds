...
class PythonAPIFileGenerator(object):
    ...
    def generate_test_file(self, function_name: str, code_block: str = None):
        ...
        with open(target_file, "w") as test_script:
            ...
            test_script.write("import unittest\n")
            ...
            if code_block:
                ...
                for line in code_block.splitlines():
                    test_script.write(f"        {line}\n")
            else:
                test_script.write("        self.skipTest('No example provided')\n\n")
...
if __name__ == "__main__":
    ...
    for dml_file in files:
        ...
        if dml_file == "dist.dml":
            print("TEST 0", test_example)
