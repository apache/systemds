...
# Autogenerated From : scripts/builtin/dbscanApply.dml
...
def dbscanApply(X: Matrix,
    ...
    op = MultiReturn(X.sds_context, 'dbscanApply', output_nodes, named_input_nodes=params_dict)
