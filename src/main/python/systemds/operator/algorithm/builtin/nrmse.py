...
# Autogenerated From : scripts/builtin/nrmse.dml
...
def nrmse(X: Matrix,
    ...
    :return: The normalized root means square error
    ...
    op = MultiReturn(X.sds_context, 'nrmse', output_nodes, named_input_nodes=params_dict)
