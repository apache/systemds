...
def shapExplainer(model_func: str,
                  model_args: List,
                  x_instances: Matrix,
                  X_bg: Matrix,
    ...
    :param model_func: The function of the model to be evaluated as a String. This function has to take a matrix of samples
    ...
    params_dict = {'model_func': model_func, 'model_args': model_args, 'x_instances': x_instances, 'X_bg': X_bg}
    params_dict.update(kwargs)
    
    vX_0 = Matrix(model_func.sds_context, '')
    vX_1 = Scalar(model_func.sds_context, '')
    output_nodes = [vX_0, vX_1, ]

    op = MultiReturn(model_func.sds_context, 'shapExplainer', output_nodes, named_input_nodes=params_dict)
