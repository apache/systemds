...
def sherlockPredict(X: OperationNode, cW1: OperationNode, cb1: OperationNode, cW2: OperationNode, cb2: OperationNode, cW3: OperationNode, cb3: OperationNode, wW1: OperationNode, wb1: OperationNode, wW2: OperationNode, wb2: OperationNode, wW3: OperationNode, wb3: OperationNode, pW1: OperationNode, pb1: OperationNode, pW2: OperationNode, pb2: OperationNode, pW3: OperationNode, pb3: OperationNode, sW1: OperationNode, sb1: OperationNode, sW2: OperationNode, sb2: OperationNode, sW3: OperationNode, sb3: OperationNode, fW1: OperationNode, fb1: OperationNode, fW2: OperationNode, fb2: OperationNode, fW3: OperationNode, fb3: OperationNode) -> OperationNode:
    ...
    return OperationNode(X.sds_context, 'sherlockPredict', named_input_nodes=params_dict, output_type=OutputType.MATRIX)
