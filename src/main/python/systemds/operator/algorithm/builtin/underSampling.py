...
# Autogenerated From : scripts/builtin/underSampling.dml
...
def underSampling(X: Matrix,
    ...
    op = MultiReturn(X.sds_context, 'underSampling', output_nodes, named_input_nodes=params_dict)
