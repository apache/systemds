...
class TestDataLoaders(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.train_indizes, cls.val_indizes = [int(i) for i in split[0]], [int(i) for i in split[1]]
        
        for m in cls.mods:
            m.data = scale_data(m.data, [int(i) for i in cls.train_indizes])
        
        cls.representations = [Concatenation(), Average(), RowMax(), Multiplication(), Sum(),
    ...
    def test_enumerate_all_vs_random(self):
        ...
        best_representation_rand, best_score_rand, best_modalities_rand = dr_search.fit_random(seed=42)
