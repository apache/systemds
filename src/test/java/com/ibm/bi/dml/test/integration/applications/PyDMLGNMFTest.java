...
public class PyDMLGNMFTest extends AutomatedTestBase 
{
	...
	public PyDMLGNMFTest(int m, int n, int k) {
		M = m; 
		N = n; 
		K = k;
	}
	...
	public void testGNMFWithRDMLAndJava() {
		...
		fullDMLScriptName = GNMF_HOME + TEST_GNMF + ".pydml";
		programArgs = new String[]{"-python", "-args", GNMF_HOME + INPUT_DIR + "v", 
