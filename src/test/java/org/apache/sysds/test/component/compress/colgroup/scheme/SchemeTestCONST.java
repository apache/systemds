...
public class SchemeTestCONST extends SchemeTestBase {
	@Parameters
	public static Collection<Object[]> data() {
		ArrayList<Object[]> tests = new ArrayList<>();
		try {
			tests.add(new Object[] {new MatrixBlock(10,1,0.0), 0});
			tests.add(new Object[] {new MatrixBlock(10,3,0.0), 0});
	...
	public SchemeTestCONST(MatrixBlock src, int distinct) {
		try {
			this.src = src;
