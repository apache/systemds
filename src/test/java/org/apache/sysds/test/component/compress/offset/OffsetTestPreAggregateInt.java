...
public class OffsetTestPreAggregateInt extends OffsetTestPreAggregate {

	public OffsetTestPreAggregateInt(int[] data, OFF_TYPE type) {
		super(data, type);
	}
	...
	private final void fill(int[] a, int v) {
