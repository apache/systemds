...
/**
 * Tests for DPBuiltinOps, ParameterizedBuiltinCPInstruction (dp_laplace/dp_gaussian), and DPBudgetAccountant.
 *
 ...
 * 3. ParameterizedBuiltinCPInstruction structural tests - exercise parseInstruction()'s
 * required-parameter validation for dp_laplace/dp_gaussian.
...
public class DPBuiltinOpsTest {
	...
	// =======================================================================
	// 3. ParameterizedBuiltinCPInstruction structural tests (dp_laplace/dp_gaussian)
	// =======================================================================

	@Test
	public void testParseInstructionValidLaplace() {
		ParameterizedBuiltinCPInstruction inst = ParameterizedBuiltinCPInstruction
	...
	public void testParseInstructionValidGaussian() {
		ParameterizedBuiltinCPInstruction inst = ParameterizedBuiltinCPInstruction.parseInstruction(
	...
	public void testParseInstructionMissingRequiredKeysThrows() {
		...
		// 6 for gaussian), but renames one required key so parseInstruction's own
