...
public class CompressedStatisticsTest {
	...
	public void testPrintWithSampledRows() {
		ArrayCompressionStatistics a = new ArrayCompressionStatistics(13, 13, false, null, false, null, 0, 0, false);
	...
	public void testPrintWithSampledRowsDDC() {
		ArrayCompressionStatistics a = new ArrayCompressionStatistics(13, 13, false, null, false, FrameArrayType.DDC, 0,
			0, false);
	...
	public void testPrintWithAllRowsRows() {
		ArrayCompressionStatistics a = new ArrayCompressionStatistics(13, 13, false, null, false, null, 0, 0, true);
