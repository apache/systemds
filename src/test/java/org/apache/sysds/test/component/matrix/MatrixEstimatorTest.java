...
public class MatrixEstimatorTest {
	...
	public void testEstimation() {
		...
		MatrixBlock out = DataConverter.convertToMatrixBlock(new double[][] {{0.0}});
		EstimatorOperator op = new EstimatorOperator(et, ht);
		try {
			LibMatrixEstimator.EstimateDistinctValues(in, out, op);
		...
		double count = out.quickGetValue(0, 0);
