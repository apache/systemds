...
public class RecompilationTest extends AutomatedTestBase {
	...
	public void test_CP_MM_Enforced() throws IOException {
		...
		runTestMM("A.csv", "B.csv", 8L*1024*1024*1024, 0, 0, Opcodes.MMULT.getName(), false);
	}
	...
	public void test_CP_MM_Preferred() throws IOException {
		...
		// Y = B.csv: (10^4)x(10^3) = 10^7 ~ 80MB
		// X %*% Y -> (10^5)x(10^3) = 10^8 ~ 800MB
		runTestMM("A.csv", "B.csv", 16L*1024*1024*1024, 2, 1024*1024*1024, Opcodes.MMULT.getName(), false);
	}
	...
	public void test_CP_TSMM() throws IOException {
		...
		runTestTSMM("B.csv", 8L*1024*1024*1024, 0, -1, Opcodes.TSMM.getName(), false);
	}
	...
	public void test_MM_RecompilationSequence() throws IOException {
		runTestMM("A.csv", "B.csv", 8L*1024*1024*1024, 0, -1, Opcodes.MMULT.getName(), false);

		runTestMM("A.csv", "B.csv", 16L*1024*1024*1024, 4, 1024*1024*1024, Opcodes.MMULT.getName(), false);
