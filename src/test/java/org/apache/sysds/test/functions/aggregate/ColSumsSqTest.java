...
public class ColSumsSqTest extends AutomatedTestBase {
	...
	private static final String op = Opcodes.UACSQKP.toString();
	...
	/**
	 * Test the column sums of squared values function, "colSums(X^2)", on dense/sparse matrices/vectors with rewrites/no
	 * rewrites on the CP/Spark/MR platforms.
	 *
	 ...
	 */
	private void testColSumsSquared(String testName, boolean sparse, boolean vector, boolean rewrites,
		ExecType platform) {
