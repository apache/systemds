...
public class LengthTest extends AutomatedTestBase {
	...
	public void setUp() {
		...
		addTestConfiguration(TEST_GENERAL,
			new TestConfiguration(TEST_CLASS_DIR, "LengthTest", new String[] {"vector_length", "matrix_length"}));

		// negative tests
		addTestConfiguration(TEST_SCALAR,
			new TestConfiguration(TEST_CLASS_DIR, "LengthScalarTest", new String[] {"computed"}));
	}
