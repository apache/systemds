...
public class NColTest extends AutomatedTestBase {
	...
	public void setUp() {
		...
		addTestConfiguration(TEST_GENERAL,
			new TestConfiguration(TEST_CLASS_DIR, "NColTest", new String[] {"vector_cols", "matrix_cols"}));

		// negative tests
		addTestConfiguration(TEST_SCALAR,
			new TestConfiguration(TEST_CLASS_DIR, "NColScalarTest", new String[] {"vector_cols", "matrix_cols"}));
	}
