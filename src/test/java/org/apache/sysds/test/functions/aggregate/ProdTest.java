...
public class ProdTest extends AutomatedTestBase {
	...
	public void setUp() {
		...
		addTestConfiguration(TEST_GENERAL,
			new TestConfiguration(TEST_CLASS_DIR, "ProdTest", new String[] {"vector_prod", "matrix_prod"}));

		// negative tests
		addTestConfiguration(TEST_SCALAR,
			new TestConfiguration(TEST_CLASS_DIR, "ProdScalarTest", new String[] {"vector_prod", "matrix_prod"}));
	}
