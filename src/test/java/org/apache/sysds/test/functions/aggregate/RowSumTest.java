...
public class RowSumTest extends AutomatedTestBase {
	...
	public void setUp() {
		...
		addTestConfiguration(TEST_GENERAL,
			new TestConfiguration(TEST_CLASS_DIR, "RowSumTest", new String[] {"vector_rowsum", "matrix_rowsum"}));

		// negative tests
		addTestConfiguration(TEST_SCALAR,
			new TestConfiguration(TEST_CLASS_DIR, "RowSumScalarTest", new String[] {"vector_rowsum", "matrix_rowsum"}));
	}
