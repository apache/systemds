...
public class RowSumsSqTest extends AutomatedTestBase {
	...
	private static final String op = Opcodes.UARSQKP.toString();
	...
	/**
	 * Test the row sums of squared values function, "rowSums(X^2)", on dense/sparse matrices/vectors with rewrites/no
	 ...
	 */
	private void testRowSumsSquared(String testName, boolean sparse, boolean vector, boolean rewrites,
		ExecType platform) {
