	...
	public void testArima(){
		...
		try {
			...
			programArgs = new String[]{
					...
					"s=" + s, "include_mean=" + include_mean, "useJacobi=" + useJacobi, "model=" + output("learnt.model"),};

			rCmd = getRCmd(input("col.mtx"), Integer.toString(max_func_invoc), Integer.toString(p), Integer.toString(d), Integer.toString(q), Integer.toString(P),
					Integer.toString(D), Integer.toString(Q), Integer.toString(s), Integer.toString(include_mean), Integer.toString(useJacobi), expected("learnt.model"));
