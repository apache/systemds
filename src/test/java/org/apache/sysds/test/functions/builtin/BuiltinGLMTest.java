...
public class BuiltinGLMTest extends AutomatedTestBase {
	...
	@Test
	public void glmTestIntercept_0_Spark() {
		setIntercept(0);
		setExecType(LopProperties.ExecType.SPARK);
		runtestGLM();
	...
	@Test
	public void glmTestIntercept_1_Spark() {
		setIntercept(1);
		setExecType(LopProperties.ExecType.SPARK);
		runtestGLM();
	...
	@Test
	public void glmTestIntercept_2_Spark() {
		setIntercept(2 );
		setExecType(LopProperties.ExecType.SPARK);
		runtestGLM();
	}
	...
	public void runtestGLM() {
		...
		try {
			...
			System.out
					.println("------------ BEGIN " + TEST_NAME + " TEST WITH {" + rows + ", " + cols + ", " + distFamilyType + ", " + distParam + ", " + linkType + ", " + linkPower + ", " + intercept + ", " + logFeatureVarianceDisbalance + ", " + avgLinearForm + ", " + stdevLinearForm + ", " + dispersion + "} ------------");
			...
			MatrixCharacteristics mc_X = new MatrixCharacteristics(rows, cols, defaultBlockSize, nnz_in_X);
	...
	public static Collection<Object[]> data() {
		...
		Object[][] data = new Object[][] {
				...
				{ 100000,   50,  1,  2.0,  1,  0.0,  3.0,   0.0,  2.0,  2.5 },   // Gamma.log
				...
				{ 100000,   50,  2, -1.0,  1,  0.0,  3.0,  -5.0,  1.0,  1.0 },   // Bernoulli {-1, 1}.log	 // Note: Y is sparse
				{ 100000,   50,  2, -1.0,  1,  1.0,  1.0,   0.6,  0.1,  1.0 },   // Bernoulli {-1, 1}.id
				{ 100000,   50,  2, -1.0,  1,  0.5,  0.0,   0.4,  0.05, 1.0 },   // Bernoulli {-1, 1}.sqrt
				{  10000,  100,  2, -1.0,  2,  0.0,  3.0,   0.0,  2.0,  1.0 },   // Bernoulli {-1, 1}.logit
				{  10000,  100,  2, -1.0,  2,  0.0,  3.0,   0.0, 50.0,  1.0 },   // Bernoulli {-1, 1}.logit   // Pr[y|x] near 0, 1
				{  20000,  100,  2, -1.0,  3,  0.0,  3.0,   0.0,  2.0,  1.0 },   // Bernoulli {-1, 1}.probit
				...
				{ 100000,   50,  2,  1.0,  1,  0.0,  3.0,  -5.0,  1.0,  2.5 },   // Binomial two-column.log   // Note: Y is sparse
				...
				{  10000,  100,  2,  1.0,  2,  0.0,  3.0,   0.0,  2.0,  2.5 },   // Binomial two-column.logit
				{  20000,  100,  2,  1.0,  3,  0.0,  3.0,   0.0,  2.0,  2.5 },   // Binomial two-column.probit
