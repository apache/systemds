...
public class BuiltinImageTranslateTest extends AutomatedTestBase {
	...
	@Test public void testImageTranslateMatrixDenseCP() { runImageTranslateTest(false, ExecType.CP); }
	...
	@Test public void testImageTranslatePillow() throws Exception {
		...
		double[][] reference = TestUtils.readMatrixFromFile(this.getClass().getResource("ImageTransformTranslated.csv"), out_h, out_w);
