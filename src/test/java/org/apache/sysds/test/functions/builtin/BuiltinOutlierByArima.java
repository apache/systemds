...
public class BuiltinOutlierByArima extends AutomatedTestBase {
	...
	public void testOutlierByArima(){
		...
		try {
			...
			double[][] comparisionSeries = deepCopy(timeSeries);
