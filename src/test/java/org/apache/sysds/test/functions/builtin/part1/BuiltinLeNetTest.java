...
public class BuiltinLeNetTest extends AutomatedTestBase {

	private static final Log LOG = LogFactory.getLog(BuiltinLeNetTest.class.getName());

	protected final static String TEST_NAME = "leNetTest";
	protected final static String TEST_DIR = "functions/builtin/";
	protected String TEST_CLASS_DIR = TEST_DIR + BuiltinLeNetTest.class.getSimpleName() + "/";

	private final String dataset_path;
	private final double least_expected_acc;
	private final String out_path;

	public BuiltinLeNetTest(String dataset_path, double least_expected_acc, String out_path) {
