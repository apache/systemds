...
public class BuiltinSplitBalancedTest extends AutomatedTestBase {
	...
	private final static String TEST_CLASS_DIR = TEST_DIR + BuiltinSplitBalancedTest.class.getSimpleName() + "/";
	...
	public void test_CP1() {
		...
		runSplitTest(0.7, ExecType.CP);

	}
	@Test
	public void test_CP2() {

		runSplitTest(0.8, ExecType.CP);

	}

	@Test
	public void test_Spark() {
		runSplitTest( 0.8, ExecType.SPARK);
	}
