...
public class LocalInstructionWithCompression extends LocalInstruction {
	private final static String TEST_NAME1 = "local";
	private final static String TEST_DIR = "functions/compress/local/";
	private final static String TEST_CLASS_DIR = TEST_DIR + LocalInstructionWithCompression.class.getSimpleName() + "/";

	public LocalInstructionWithCompression() {
		super();
	}
	...
	protected File getConfigTemplateFile() {
		return new File(SCRIPT_DIR + TEST_DIR, "SystemDS-config.xml");
	}
}
