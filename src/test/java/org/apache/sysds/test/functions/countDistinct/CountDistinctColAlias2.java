...
public class CountDistinctColAlias2 extends CountDistinctRowOrColBase {

	private final static String TEST_NAME = "countDistinctColAlias2";
	private final static String TEST_DIR = "functions/countDistinct/";
	private final static String TEST_CLASS_DIR = TEST_DIR + CountDistinctColAlias2.class.getSimpleName() + "/";
