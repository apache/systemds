...
public class CountDistinctRowAlias2 extends CountDistinctRowOrColBase {

	private final static String TEST_NAME = "countDistinctRowAlias2";
	private final static String TEST_DIR = "functions/countDistinct/";
	private final static String TEST_CLASS_DIR = TEST_DIR + CountDistinctRowAlias2.class.getSimpleName() + "/";
