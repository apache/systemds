...
public class FederatedMultiplyPlanningTest extends AutomatedTestBase {
	...
	private static File TEST_CONF_FILE = new File(SCRIPT_DIR + TEST_DIR, "SystemDS-config-heuristic.xml");
	...
	public void federatedMultiplyDoubleHop() {
		String[] expectedHeavyHitters = new String[]{"fed_*", "fed_fedinit", "fed_ba+*"}; //TODO "fed_r' " ?
	...
	public void federatedMultiplyPlanningTest9(){
		String[] expectedHeavyHitters = new String[]{"fed_+*", "fed_1-*", "fed_fedinit", "fed_max"}; //TODO "fed_tak+*"
