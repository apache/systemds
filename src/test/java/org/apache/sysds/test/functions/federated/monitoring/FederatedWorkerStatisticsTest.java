...
public class FederatedWorkerStatisticsTest extends FederatedMonitoringTestBase {
    ...
    public void testWorkerStatisticsReturnedForMonitoring() {
        ...
        Assert.assertNotEquals("Data field of model contains worker statistics",
                0,
                model.getData().length());
        Assert.assertTrue("Data field of model contains worker statistics",
                model.getData().contains("JVM"));
    }
}
