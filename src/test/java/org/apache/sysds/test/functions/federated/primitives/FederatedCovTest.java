...
public class FederatedCovTest extends AutomatedTestBase {

	private final static String TEST_NAME = "FederatedCovTest";

	private final static String TEST_DIR = "functions/federated/";
	private static final String TEST_CLASS_DIR = TEST_DIR + FederatedCovTest.class.getSimpleName() + "/";
