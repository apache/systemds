...
public class FederatedFullAggregateTest extends AutomatedTestBase {
    ...
    @Test
    public void testMeanDenseMatrixCP() { runColAggregateOperationTest(OpType.MEAN, ExecType.CP); }
    ...
    @Test
    public void testMeanDenseMatrixSP() { runColAggregateOperationTest(OpType.MEAN, ExecType.SPARK); }
    ...
    private void runColAggregateOperationTest( OpType type, ExecType instType)
    {
        ...
        switch( type )
        {
            case SUM: Assert.assertTrue(heavyHittersContainsString("fed_uak+")); break;
            case MEAN: Assert.assertTrue(heavyHittersContainsString("fed_uamean")); break;
            case MAX: Assert.assertTrue(heavyHittersContainsString("fed_uamax")); break;
            case MIN: Assert.assertTrue(heavyHittersContainsString("fed_uamin")); break;
        }
