...
public class FederatedLeftIndexTest extends AutomatedTestBase {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {{8, 2, 8, 1, 1, 8, 1, 1, true}, {24, 12, 20, 8, 3, 22, 1, 8, true},
			{24, 12, 10, 8, 7, 16, 1, 8, true}, {24, 12, 20, 11, 3, 22, 1, 11, false}, {24, 12, 20, 8, 3, 22, 1, 8, false},
		...
		try {
			...
			try {
				...
				programArgs = new String[] {"-args", input("X1"), input("X2"), input("X3"), input("X4"), input("Y"),
					String.valueOf(lfrom), String.valueOf(to), String.valueOf(lfrom2), String.valueOf(to2),
				...
				programArgs = new String[] {"-stats", "100", "-nvargs",
					...
					"in_X4=" + TestUtils.federatedAddress(port4, input("X4")), "in_Y=" + input("Y"), "rows=" + rows1,
					"cols=" + cols1, "rows2=" + rows2, "cols2=" + cols2, "from=" + from, "to=" + to, "from2=" + from2,
					"to2=" + to2, "rP=" + Boolean.toString(rowPartitioned).toUpperCase(), "out_S=" + output("S")};
				...
				Assert.assertTrue(rtplatform == ExecMode.SPARK ? heavyHittersContainsString(
					"fed_mapLeftIndex") : heavyHittersContainsString("fed_leftIndex"));
