...
public class FederatedReplaceTest extends AutomatedTestBase {
	...
	private static final String TEST_CLASS_DIR = TEST_DIR + FederatedReplaceTest.class.getSimpleName() + "/";
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(
			new Object[][] {{20, 12, true, true}, {20, 12, false, true}, {20, 12, true, false}, {20, 12, false, false}});
	}
	...
	private void runAggregateOperationTest(ExecMode execMode) {
		...
		try {
			...
			programArgs = new String[] {"-stats", "100", "-args", input("X1"), input("X2"), input("X3"), input("X4"),
				Boolean.toString(rowPartitioned).toUpperCase(), expected("S"), Boolean.toString(isFrame).toUpperCase()};
