...
public class FederatedWeightedUnaryMatrixMultTest extends AutomatedTestBase {
	...
	@Override
	public void setUp() {
		addTestConfiguration(EXP_MULT_TEST_NAME,
			new TestConfiguration(TEST_CLASS_DIR, EXP_MULT_TEST_NAME, new String[] {OUTPUT_NAME}));
		addTestConfiguration(EXP_DIV_TEST_NAME,
			new TestConfiguration(TEST_CLASS_DIR, EXP_DIV_TEST_NAME, new String[] {OUTPUT_NAME}));
		addTestConfiguration(POW_2_TEST_NAME,
			new TestConfiguration(TEST_CLASS_DIR, POW_2_TEST_NAME, new String[] {OUTPUT_NAME}));
		addTestConfiguration(MULT_2_TEST_NAME,
			new TestConfiguration(TEST_CLASS_DIR, MULT_2_TEST_NAME, new String[] {OUTPUT_NAME}));
	}
	...
	public static Collection<Object[]> data() {
		...
		return Arrays.asList(new Object[][] {
			...
			{1202, 1003, 5, 0.001}, {1202, 1003, 5, 0.7}});
	}
