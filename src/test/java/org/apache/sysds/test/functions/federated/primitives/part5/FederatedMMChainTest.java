...
public class FederatedMMChainTest extends AutomatedTestBase {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {{1000, 100, true}, {100, 1000, false}});
	}
	...
	@Test
	public void testMMChainCP() {
		runMMChainTest(ExecMode.SINGLE_NODE, TEST_NAME1);
	}
	...
	@Test
	public void testMMChainSP() {
		runMMChainTest(ExecMode.SPARK, TEST_NAME1);
	}

	@Test
	public void testMMChainWeightsSP() {
		runMMChainTest(ExecMode.SPARK, TEST_NAME2);
	}

	@Test
	public void testMMChainWeights2SP() {
		runMMChainTest(ExecMode.SPARK, TEST_NAME3);
	}
	...
	private void runMMChainTest(ExecMode execMode, String TEST_NAME) {
		...
		try {
			...
			programArgs = new String[] {"-stats", "100", "-nvargs",
				...
				"rP=" + Boolean.toString(rowPartitioned).toUpperCase(), "in_v=" + input("v"), "in_w=" + input("w"),
				"out_S=" + output("S")};
			runTest(null);
