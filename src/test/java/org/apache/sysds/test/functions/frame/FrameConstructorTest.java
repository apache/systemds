...
public class FrameConstructorTest extends AutomatedTestBase  {
	...
	private final static ValueType[] schemaStrings = new ValueType[]{ValueType.INT64, ValueType.STRING,
	...
	public void testFrameNamedParam()  {
		FrameBlock exp = new FrameBlock(schemaStrings);
		String[] out = new String[]{"1", "abc", "2.5", "TRUE"};
	...
	@Ignore
	public void testFrameNamedParamSpark()  {
		FrameBlock exp = new FrameBlock(schemaStrings);
		String[] out = new String[]{"1", "abc", "2.5", "TRUE"};
		for(int i=0; i<rows; i++)
			exp.appendRow(out);
	...
	public void testNoSchema()  {
		schemaStrings[3] = ValueType.STRING;
		FrameBlock exp = new FrameBlock(schemaStrings);
		String[] out = new String[]{"1", "abc", "2.5", "TRUE"};
		for(int i=0; i<rows; i++)
			exp.appendRow(out);
	...
	public void testRandData()  {
		FrameBlock exp = UtilFunctions.generateRandomFrameBlock(rows, cols,  schemaStrings, new Random(10));
