...
import org.apache.sysds.test.functions.io.libsvm.WriteLIBSVMTest;

public abstract class WriteHDF5TestBase extends AutomatedTestBase {

	protected final static String TEST_DIR = "functions/io/hdf5/";
	protected final static String TEST_CLASS_DIR = TEST_DIR + WriteHDF5Test.class.getSimpleName() + "/";
