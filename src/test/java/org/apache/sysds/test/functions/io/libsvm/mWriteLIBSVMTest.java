...
public class mWriteLIBSVMTest extends AutomatedTestBase {

	protected final static String TEST_DIR = "functions/io/libsvm/";
	private final static String TEST_NAME = "ReadLIBSVMTest";
	protected final static String TEST_CLASS_DIR = TEST_DIR + mWriteLIBSVMTest.class.getSimpleName() + "/";
	...
	@Test public void testFrameLibsvm1_SP() {
		runlibsvmTest(1, ExecMode.SPARK, false," ",":",false);
	}

	private void runlibsvmTest(int testNumber, ExecMode platform, boolean parallel, String sep, String indSep, boolean sparse) {
		...
		try {
			...
			programArgs = new String[] {"-args", inputMatrixNameWithExtension, dmlOutput, sep, indSep, Boolean.toString(sparse)};
