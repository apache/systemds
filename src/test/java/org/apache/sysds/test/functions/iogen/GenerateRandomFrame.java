...
public class GenerateRandomFrame extends AutomatedTestBase {
	...
	private void writeInCSVFormat(String[][] data, int nrows, int ncols, String fileName, String separator,
	...
	private String[][] writeInLIBSVMFormat(int firstIndex,Types.ValueType[] schema, String[][] data, int nrows, int ncols, String fileName,
	...
	private void writeInMatrixMarketFormat(int firstIndex, String[][] data, int nrows, int ncols, String fileName,
	...
	// Write 2D Data in CSV format
	private void writeSampleFrame(Types.ValueType[] schema, String[][] sample, String fileName, int nrows, int ncols)
		throws Exception {
	...
	@Test public void generateDataset() throws Exception {
		int nrows = 5000;
		int ncols = 5000;
		double sparsity = 1;
	...
	private void saveData(Types.ValueType[] schema, String[][] data, int nrows, int ncols, String separator,
