...
public class GenerateRandomMatrix extends AutomatedTestBase {
	...
	private void writeInCSVFormat(double[][] data, int nrows, int ncols, String fileName, String separator,
	...
	private double[][] writeInLIBSVMFormat(int firstIndex, double[][] data, int nrows, int ncols, String fileName,
	...
	private void writeInMatrixMarketFormat(int firstIndex, double[][] data, int nrows, int ncols, String fileName,
	...
	private void writeInSymmetricMatrixMarketFormat(int firstIndex, double[][] data, String fileName, int size,
	...
	// Write 2D Data in CSV format
	private void writeSampleMatrix(double[][] sample, String fileName, int nrows, int ncols) throws Exception {
