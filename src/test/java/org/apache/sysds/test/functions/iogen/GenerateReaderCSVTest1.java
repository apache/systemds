...
public class GenerateReaderCSVTest1 extends AutomatedTestBase {
	...
	private final static String TEST_CLASS_DIR = TEST_DIR + GenerateReaderCSVTest1.class.getSimpleName() + "/";
