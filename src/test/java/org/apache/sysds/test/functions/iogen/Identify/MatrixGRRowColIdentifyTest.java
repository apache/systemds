...
public class MatrixGRRowColIdentifyTest extends GenerateReaderMatrixTest {
	...
	public void test9() {
		...
		sampleMatrix = new double[][] {{1,2,3,1980}, {10,20,30,2000}, {100,200,300,2010},{1000,2000,3000,2222}};
		runGenerateReaderTest();
	}
	...
	public void test10() {
		...
		sampleMatrix = new double[][] {{1,2,3,1980}, {10,21,30,2000}, {100,200,300,2010},{1000,2000,3000,2222}};
		runGenerateReaderTest();
	}
...
//		runGenerateReaderTest();
		...
		StringBuilder sb = new StringBuilder(" ,)R2I( hcraeseR mmocofnI rof etutitsnI ,tnemtrapeD gniniM ataD\"[:\"snoitailiffa\",\"tuhN hniM neyugN \":\"eman\",802:\"xedni\"{");
