...
public class ReplaceTest extends AutomatedTestBase {
	private final static String TEST_NAME1 = "Replace";
	private final static String TEST_DIR = "functions/ooc/";
	private final static String TEST_CLASS_DIR = TEST_DIR + ReplaceTest.class.getSimpleName() + "/";
	...
	@Test
	public void testReplaceSparse() {
		runReplaceTest(true);
	}

	private void runReplaceTest(boolean sparse) {
		...
		try {
			...
			X_mb = X_mb.unaryOperations(new UnaryOperator(Builtin.getBuiltinFnObject(Builtin.BuiltinCode.ROUND)));
