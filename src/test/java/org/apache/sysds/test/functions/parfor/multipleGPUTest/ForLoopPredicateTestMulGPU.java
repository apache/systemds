 ...
 */
 ...
 package org.apache.sysds.test.functions.parfor.multipleGPUTest;
 ...
 public class ForLoopPredicateTestMulGPU extends AutomatedTestBase 
 {
     ...
     private final static String TEST_CLASS_DIR = TEST_DIR + ForLoopPredicateTestMulGPU.class.getSimpleName() + "/";
     ...
     @Test
     public void testParFor3IntNegativeIncrement() {
         runForPredicateTest(9, true, true);
     }
    ...
    // set TEST_GPU = true, VERBOSE_STATS = true and test for -gpu -stats
