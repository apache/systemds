...
public class BuiltinImagePosterizeTest extends AutomatedTestBase {
	...
	@Test
	public void testImagePosterizeMatrixDenseCP() { runImagePosterizeTest(false, ExecType.CP); }

	@Test
	public void testImagePosterizeMatrixSparseCP() {
		runImagePosterizeTest(true, ExecType.CP);
	}

	@Test
	public void testImagePosterizeMatrixDenseSP() {
		runImagePosterizeTest(false, ExecType.SPARK);
	}

	@Test
	public void testImagePosterizeMatrixSparseSP() {
		runImagePosterizeTest(false, ExecType.SPARK);
	}

	@Test
	public void testImagePosterizePillow() throws Exception {
		loadTestConfiguration(getTestConfiguration(TEST_NAME));
		final int w = 500, h = 135;
		
		double[][] input = TestUtils.readExpectedResource("ImageTransformInput.csv", h, w);
		double[][] reference = TestUtils.readExpectedResource("ImageTransformPosterized.csv", h, w);
