...
public class BuiltinImageSamplePairingTest extends AutomatedTestBase {
	...
	@Test
	public void testImageSamplePairingMatrixDenseCP() {
		runImageSamplePairingTest(false, ExecType.CP);
	}

	@Test
	public void testImageSamplePairingMatrixSparseCP() {
		runImageSamplePairingTest(true, ExecType.CP);
	}

	@Test
	public void testImageSamplePairingMatrixDenseSP() {
		runImageSamplePairingTest(false, ExecType.SPARK);
	}

	@Test
	public void testImageSamplePairingMatrixSparseSP() {
		runImageSamplePairingTest(false, ExecType.SPARK);
	}
