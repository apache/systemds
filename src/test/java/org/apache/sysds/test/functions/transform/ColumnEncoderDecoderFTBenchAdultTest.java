...
public class ColumnEncoderDecoderFTBenchAdultTest extends AutomatedTestBase {

    private static final String TEST_NAME = "adultBenchmark";
    ...
    // Dataset & spec paths
    private static final String DATASET = "adult/adult.csv";
    @Override
    public void setUp() {
    ...
    public void runFrameTransformBenchmark() {
        runBenchmark(ExecMode.SINGLE_NODE);
    }

    private void runBenchmark(ExecMode execMode) {
