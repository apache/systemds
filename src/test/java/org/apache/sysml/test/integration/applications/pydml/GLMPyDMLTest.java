...
public class GLMPyDMLTest extends GLMTest {
	...
	public GLMPyDMLTest(int numRecords_, int numFeatures_, int distFamilyType_, double distParam_, int linkType_,
	...
	@Test
	public void testGLMPyDml() {
		testGLM(ScriptType.PYDML);
	}
