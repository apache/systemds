...
public class AlgorithmAutoEncoder extends AutomatedTestBase 
{
	...
	@Test
	public void testAutoEncoder512DenseCPFuseAll() {
		runAutoEncoderTest(512, false, false, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testAutoEncoder512SparseCPFuseAll() {
		runAutoEncoderTest(512, true, false, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testAutoEncoder512DenseCPFuseNoRedundancy() {
		runAutoEncoderTest(512, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testAutoEncoder512SparseCFuseNoRedundancyP() {
		runAutoEncoderTest(512, true, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testAutoEncoder256DenseRewritesSparkFuseNoRedundancy() {
		runAutoEncoderTest(256, false, true, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testAutoEncoder256SparseRewritesSparkFuseNoRedundancy() {
		runAutoEncoderTest(256, true, true, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
