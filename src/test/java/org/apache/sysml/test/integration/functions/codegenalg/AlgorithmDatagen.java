...
public class AlgorithmDatagen extends AutomatedTestBase 
{
	...
	@Test
	public void testDatagenLinregDenseNoRewritesCPFuseAll() {
		runStepwiseTest(DatagenType.LINREG, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testDatagenLinregSparseNoRewritesCPFuseAll() {
		runStepwiseTest(DatagenType.LINREG, true, false, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testDatagenLogregDenseNoRewritesCPFuseAll() {
		runStepwiseTest(DatagenType.LOGREG, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testDatagenLogregSparseNoRewritesCPFuseAll() {
		runStepwiseTest(DatagenType.LOGREG, true, false, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testDatagenLinregDenseNoRewritesSPFuseAll() {
		runStepwiseTest(DatagenType.LINREG, false, false, ExecType.SPARK, TestType.FUSE_ALL);
	}

	@Test
	public void testDatagenLinregSparseNoRewritesSPFuseAll() {
		runStepwiseTest(DatagenType.LINREG, true, false, ExecType.SPARK, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testDatagenLogregDenseNoRewritesSPFuseAll() {
		runStepwiseTest(DatagenType.LOGREG, false, false, ExecType.SPARK, TestType.DEFAULT);
	}

	@Test
	public void testDatagenLogregSparseNoRewritesSPFuseAll() {
		runStepwiseTest(DatagenType.LOGREG, true, false, ExecType.SPARK, TestType.DEFAULT);
	}
	...
	@Test
	public void testDatagenLinregDenseNoRewritesCPFuseNoRedundancy() {
		runStepwiseTest(DatagenType.LINREG, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testDatagenLinregSparseNoRewritesCPFuseNoRedundancy() {
		runStepwiseTest(DatagenType.LINREG, true, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testDatagenLogregDenseNoRewritesCPFuseNoRedundancy() {
		runStepwiseTest(DatagenType.LOGREG, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testDatagenLogregSparseNoRewritesCPFuseNoRedundancy() {
		runStepwiseTest(DatagenType.LOGREG, true, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testDatagenLinregDenseNoRewritesSPFuseNoRedundancy() {
		runStepwiseTest(DatagenType.LINREG, false, false, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testDatagenLinregSparseNoRewritesSPFuseNoRedundancy() {
		runStepwiseTest(DatagenType.LINREG, true, false, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testDatagenLogregDenseNoRewritesSPFuseNoRedundancy() {
		runStepwiseTest(DatagenType.LOGREG, false, false, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testDatagenLogregSparseNoRewritesSPFuseNoRedundancy() {
		runStepwiseTest(DatagenType.LOGREG, true, false, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
