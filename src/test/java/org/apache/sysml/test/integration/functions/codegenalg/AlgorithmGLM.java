...
{	
	...
	public void testGLMPoissonDenseSP() {
		runGLMTest(GLMType.POISSON_LOG, false, false, ExecType.SPARK, TestType.DEFAULT);
	}
	
	@Test
	public void testGLMPoissonSparseSP() {
		runGLMTest(GLMType.POISSON_LOG, false, true, ExecType.SPARK, TestType.DEFAULT);
	}
	...
	public void testGLMGammaDenseSP() {
		runGLMTest(GLMType.GAMMA_LOG, false, false, ExecType.SPARK, TestType.DEFAULT);
	}
	
	@Test
	public void testGLMGammaSparseSP() {
		runGLMTest(GLMType.GAMMA_LOG, false, true, ExecType.SPARK, TestType.DEFAULT);
	}
	...
	public void testGLMBinomialDenseSP() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, false, ExecType.SPARK, TestType.DEFAULT);
	}
	
	@Test
	public void testGLMBinomialSparseSP() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, true, ExecType.SPARK, TestType.DEFAULT);
	}
	...
	@Test
	public void testGLMPoissonDenseCPFuseAll() {
		runGLMTest(GLMType.POISSON_LOG, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testGLMPoissonSparseCPFuseAll() {
		runGLMTest(GLMType.POISSON_LOG, false, true, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testGLMGammaDenseCPFuseAll() {
		runGLMTest(GLMType.GAMMA_LOG, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testGLMGammaSparseCPFuseAll() {
		runGLMTest(GLMType.GAMMA_LOG, false, true, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testGLMBinomialDenseCPFuseAll() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testGLMBinomialSparseCPFuseAll() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, true, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testGLMPoissonDenseSPFuseAll() {
		runGLMTest(GLMType.POISSON_LOG, false, false, ExecType.SPARK, TestType.FUSE_ALL);
	}

	@Test
	public void testGLMPoissonSparseSPFuseAll() {
		runGLMTest(GLMType.POISSON_LOG, false, true, ExecType.SPARK, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testGLMGammaDenseSPFuseAll() {
		runGLMTest(GLMType.GAMMA_LOG, false, false, ExecType.SPARK, TestType.FUSE_ALL);
	}

	@Test
	public void testGLMGammaSparseSPFuseAll() {
		runGLMTest(GLMType.GAMMA_LOG, false, true, ExecType.SPARK, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testGLMBinomialDenseSPFuseAll() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, false, ExecType.SPARK, TestType.FUSE_ALL);
	}

	@Test
	public void testGLMBinomialSparseSPFuseAll() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, true, ExecType.SPARK, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testGLMPoissonDenseCPFuseNoRedundancy() {
		runGLMTest(GLMType.POISSON_LOG, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testGLMPoissonSparseCPFuseNoRedundancy() {
		runGLMTest(GLMType.POISSON_LOG, false, true, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testGLMGammaDenseCPFuseNoRedundancy() {
		runGLMTest(GLMType.GAMMA_LOG, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testGLMGammaSparseCPFuseNoRedundancy() {
		runGLMTest(GLMType.GAMMA_LOG, false, true, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testGLMBinomialDenseCPFuseNoRedundancy() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testGLMBinomialSparseCPFuseNoRedundancy() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, true, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testGLMPoissonDenseSPFuseNoRedundancy() {
		runGLMTest(GLMType.POISSON_LOG, false, false, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testGLMPoissonSparseSPFuseNoRedundancy() {
		runGLMTest(GLMType.POISSON_LOG, false, true, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testGLMGammaDenseSPFuseNoRedundancy() {
		runGLMTest(GLMType.GAMMA_LOG, false, false, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testGLMGammaSparseSPFuseNoRedundancy() {
		runGLMTest(GLMType.GAMMA_LOG, false, true, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testGLMBinomialDenseSPFuseNoRedundancy() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, false, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testGLMBinomialSparseSPFuseNoRedundancy() {
		runGLMTest(GLMType.BINOMIAL_PROBIT, false, true, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
