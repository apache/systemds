...
{	
	...
	@Test
	public void testLinregCG0DenseCPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, false, 0, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testLinregCG0SparseCPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, true, 0, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testLinregCG0DenseSPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, false, 0, ExecType.SPARK, TestType.FUSE_ALL);
	}

	@Test
	public void testLinregCG0SparseSPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, true, 0, ExecType.SPARK, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testLinregCG1DenseCPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, false, 1, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testLinregCG1SparseCPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, true, 1, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testLinregCG1DenseSPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, false, 1, ExecType.SPARK, TestType.FUSE_ALL);
	}

	@Test
	public void testLinregCG1SparseSPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, true, 1, ExecType.SPARK, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testLinregCG2DenseCPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, false, 2, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testLinregCG2SparseCPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, true, 2, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testLinregCG2DenseSPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, false, 2, ExecType.SPARK, TestType.FUSE_ALL);
	}

	@Test
	public void testLinregCG2SparseSPFuseAll() {
		runLinregCGTest(TEST_NAME1, false, true, 2, ExecType.SPARK, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testLinregCG0DenseCPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, false, 0, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testLinregCG0SparseCPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, true, 0, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testLinregCG0DenseSPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, false, 0, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testLinregCG0SparseSPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, true, 0, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testLinregCG1DenseCPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, false, 1, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testLinregCG1SparseCPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, true, 1, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testLinregCG1DenseSPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, false, 1, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testLinregCG1SparseSPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, true, 1, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testLinregCG2DenseCPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, false, 2, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testLinregCG2SparseCPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, true, 2, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testLinregCG2DenseSPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, false, 2, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testLinregCG2SparseSPFuseNoRedundancy() {
		runLinregCGTest(TEST_NAME1, false, true, 2, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
