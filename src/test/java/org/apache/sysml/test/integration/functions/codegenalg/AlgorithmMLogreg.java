...
public class AlgorithmMLogreg extends AutomatedTestBase 
{
	...
	@Test
	public void testMlogregBin0DenseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 2, 0, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testMlogregBin0SparseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 2, 0, false, true, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMlogregMul0DenseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 5, 0, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testMlogregMul0SparseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 5, 0, false, true, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMlogregBin0DenseSPFuseAll() {
		runMlogregTest(TEST_NAME1, 2, 0, false, false, ExecType.SPARK, TestType.FUSE_ALL);
	}

	@Test
	public void testMlogregBin0SparseSPFuseAll() {
		runMlogregTest(TEST_NAME1, 2, 0, false, true, ExecType.SPARK, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMlogregMul0DenseSPFuseAll() {
		runMlogregTest(TEST_NAME1, 5, 0, false, false, ExecType.SPARK, TestType.FUSE_ALL);
	}

	@Test
	public void testMlogregMul0SparseSPFuseAll() {
		runMlogregTest(TEST_NAME1, 5, 0, false, true, ExecType.SPARK, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMlogregBin1DenseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 2, 1, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testMlogregBin1SparseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 2, 1, false, true, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMlogregMul1DenseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 5, 1, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testMlogregMul1SparseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 5, 1, false, true, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMlogregBin2DenseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 2, 2, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testMlogregBin2SparseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 2, 2, false, true, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMlogregMul2DenseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 5, 2, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testMlogregMul2SparseCPFuseAll() {
		runMlogregTest(TEST_NAME1, 5, 2, false, true, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMlogregBin0DenseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 2, 0, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMlogregBin0SparseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 2, 0, false, true, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testMlogregMul0DenseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 5, 0, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMlogregMul0SparseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 5, 0, false, true, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testMlogregBin0DenseSPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 2, 0, false, false, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMlogregBin0SparseSPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 2, 0, false, true, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testMlogregMul0DenseSPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 5, 0, false, false, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMlogregMul0SparseSPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 5, 0, false, true, ExecType.SPARK, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testMlogregBin1DenseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 2, 1, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMlogregBin1SparseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 2, 1, false, true, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testMlogregMul1DenseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 5, 1, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMlogregMul1SparseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 5, 1, false, true, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testMlogregBin2DenseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 2, 2, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMlogregBin2SparseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 2, 2, false, true, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testMlogregMul2DenseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 5, 2, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMlogregMul2SparseCPFuseNoRedundancy() {
		runMlogregTest(TEST_NAME1, 5, 2, false, true, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
