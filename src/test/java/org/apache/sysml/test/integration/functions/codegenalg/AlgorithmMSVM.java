...
{	
	...
	@Test
	public void testMSVMDenseBinCPFuseAll() {
		runMSVMTest(TEST_NAME1, false, false, 2, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testMSVMSparseBinCPFuseAll() {
		runMSVMTest(TEST_NAME1, false, true, 2, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMSVMDenseMulCPFuseAll() {
		runMSVMTest(TEST_NAME1, false, false, 4, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testMSVMSparseMulCPFuseAll() {
		runMSVMTest(TEST_NAME1, false, true, 4, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testMSVMDenseBinCPFuseNoRedundancy() {
		runMSVMTest(TEST_NAME1, false, false, 2, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMSVMSparseBinCPFuseNoRedundancy() {
		runMSVMTest(TEST_NAME1, false, true, 2, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testMSVMDenseMulCPFuseNoRedundancy() {
		runMSVMTest(TEST_NAME1, false, false, 4, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testMSVMSparseMulCPFuseNoRedundancy() {
		runMSVMTest(TEST_NAME1, false, true, 4, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
