...
//	}
	...
	@Test
	public void testStepwiseGLMDenseNoRewritesCPFuseAll() {
		runStepwiseTest(StepwiseType.GLM_PROBIT, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testStepwiseGLMSparseNoRewritesCPFuseAll() {
		runStepwiseTest(StepwiseType.GLM_PROBIT, true, false, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testStepwiseLinregDSDenseNoRewritesCPFuseAll() {
		runStepwiseTest(StepwiseType.LINREG_DS, false, false, ExecType.CP, TestType.FUSE_ALL);
	}

	@Test
	public void testStepwiseLinregDSSparseNoRewritesCPFuseAll() {
		runStepwiseTest(StepwiseType.LINREG_DS, true, false, ExecType.CP, TestType.FUSE_ALL);
	}
	...
	@Test
	public void testStepwiseGLMDenseNoRewritesCPFuseNoRedundancy() {
		runStepwiseTest(StepwiseType.GLM_PROBIT, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testStepwiseGLMSparseNoRewritesCPFuseNoRedundancy() {
		runStepwiseTest(StepwiseType.GLM_PROBIT, true, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
	...
	@Test
	public void testStepwiseLinregDSDenseNoRewritesCPFuseNoRedundancy() {
		runStepwiseTest(StepwiseType.LINREG_DS, false, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}

	@Test
	public void testStepwiseLinregDSSparseNoRewritesCPFuseNoRedundancy() {
		runStepwiseTest(StepwiseType.LINREG_DS, true, false, ExecType.CP, TestType.FUSE_NO_REDUNDANCY);
	}
